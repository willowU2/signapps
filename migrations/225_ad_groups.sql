...
CREATE TABLE IF NOT EXISTS ad_security_groups (
...
CREATE INDEX IF NOT EXISTS idx_ad_groups_domain ON ad_security_groups(domain_id);
CREATE INDEX IF NOT EXISTS idx_ad_groups_source ON ad_security_groups(source_type, source_id);
...
CREATE INDEX IF NOT EXISTS idx_ad_gm_group ON ad_group_members(group_id);
