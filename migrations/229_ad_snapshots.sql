...
CREATE INDEX IF NOT EXISTS idx_snapshots_domain ON ad_snapshots(domain_id);
CREATE INDEX IF NOT EXISTS idx_snapshots_type ON ad_snapshots(snapshot_type, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_snapshots_status ON ad_snapshots(status) WHERE status IN ('creating', 'restoring');
