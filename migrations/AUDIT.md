...
| `migrations/008_collections.sql` | ADD CONSTRAINT without DO-block guard | 1 |
...
| `migrations/016_chat_support.sql` | ADD CONSTRAINT without DO-block guard | 1 |
...
| `migrations/024_ai_collections_defaults.sql` | ADD CONSTRAINT without DO-block guard | 1 |
...
| `migrations/038_ai_ingestion_triggers.sql` | ADD CONSTRAINT without DO-block guard | 1 |
| `migrations/048_update_drive_nodes_check_constraint.sql` | ADD CONSTRAINT without DO-block guard | 1 |
| `migrations/049_calendar_attendees_external.sql` | ADD CONSTRAINT without DO-block guard | 2 |
...
| `migrations/060_combined.sql` | ADD CONSTRAINT without DO-block guard | 2 |
...
| `migrations/091_notifications_schema_reconcile.sql` | ADD CONSTRAINT without DO-block guard | 1 |
| `migrations/116_it_tables_extend.sql` | ADD CONSTRAINT without DO-block guard | 1 |
| `migrations/148_fix_drive_nodes_unique_constraint.sql` | ADD CONSTRAINT without DO-block guard | 1 |
| `migrations/20260411085535_drive_nodes_unique_node_type.sql` | ADD CONSTRAINT without DO-block guard | 1 |
| `migrations/211_org_boards.sql` | CREATE [UNIQUE] INDEX without IF NOT EXISTS | 2 |
| `migrations/212_governance_policy_domain.sql` | ADD CONSTRAINT without DO-block guard | 1 |
...
| `migrations/234_add_presentation_to_drive_constraint.sql` | ADD CONSTRAINT without DO-block guard | 1 |
...
**Total offending statements:** 404
