...
DO $$ BEGIN ALTER TABLE documents ADD CONSTRAINT documents_doc_type_check 
    CHECK (doc_type IN ('text', 'sheet', 'slide', 'board', 'chat', 'dm')); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN ALTER TABLE mail.email_templates ADD CONSTRAINT uq_templates_account_name UNIQUE (account_id, name); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
