...
DO $$ BEGIN ALTER TABLE drive.nodes ADD CONSTRAINT nodes_owner_parent_name_del_key UNIQUE NULLS NOT DISTINCT (owner_id, parent_id, name, deleted_at); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
