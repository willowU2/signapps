...
#[openapi(
    ...
    paths(
        ...
        // Vault
        crate::handlers::vault::init_keys,
        crate::handlers::vault::get_keys,
        crate::handlers::vault::update_keys,
        crate::handlers::vault::list_items,
        crate::handlers::vault::create_item,
        crate::handlers::vault::update_item,
        crate::handlers::vault::delete_item,
        crate::handlers::vault::list_folders,
        crate::handlers::vault::create_folder,
        crate::handlers::vault::update_folder,
        crate::handlers::vault::delete_folder,
        crate::handlers::vault::create_share,
        crate::handlers::vault::delete_share,
        crate::handlers::vault::shared_with_me,
        crate::handlers::vault::get_totp_code,
        crate::handlers::vault::generate_password,
        crate::handlers::vault::upsert_org_key,
        crate::handlers::vault::get_org_key,
        crate::handlers::vault::list_audit,
        crate::handlers::vault::start_browse,
        crate::handlers::vault::end_browse,
        // Compliance
    ...
    components(
        schemas(
            ...
            // Vault schemas (handler DTOs)
            crate::handlers::vault::CreateShareRequest,
            crate::handlers::vault::TotpRequest,
            crate::handlers::vault::TotpCodeResponse,
            crate::handlers::vault::GeneratedPasswordResponse,
            crate::handlers::vault::BrowseSessionResponse,
            // Vault schemas (DB models)
            signapps_db::models::vault::UpsertVaultUserKeys,
            signapps_db::models::vault::CreateVaultItem,
            signapps_db::models::vault::UpdateVaultItem,
            signapps_db::models::vault::CreateVaultFolder,
            signapps_db::models::vault::UpdateVaultFolder,
            signapps_db::models::vault::UpsertVaultOrgKey,
            signapps_db::models::vault::CreateBrowseSession,
            signapps_db::models::vault::VaultItemType,
            signapps_db::models::vault::VaultShareType,
            signapps_db::models::vault::VaultAccessLevel,
            signapps_db::models::vault::VaultAuditAction,
            // Compliance schemas
    ...
    tags(
        ...
        (name = "vault", description = "Vault enterprise — encrypted credentials and secrets"),
