    ...
    let nodes = if let Some(pid) = parent_id {
        ...
        sqlx::query_as::<_, DriveNode>(
            ...
            SELECT n.id, n.parent_id, n.name, n.node_type, 
                   n.target_id, n.owner_id, n.size, n.mime_type, 
...
pub async fn create_node(
    ...
    let node = sqlx::query_as::<_, DriveNode>(
        ...
        VALUES ($1, $2, $3::drive.node_type, $4, $5, $6, $7)
...
pub async fn update_node(
    ...
    query.push(" RETURNING id, parent_id, name, node_type, target_id, owner_id, size, mime_type, created_at, updated_at, deleted_at");
