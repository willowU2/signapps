...
const FUNCTIONS = [
  ...
  },
  {
    ...
    description: "Ingénieur DevOps/SRE",
    category: "technique",
  },
  {
    code: "QA",
    name: "QA Engineer",
    description: "Ingénieur qualité",
    category: "technique",
  },
  {
    code: "DESIGN",
  ...
  },
  {
    code: "SALES",
    name: "Commercial",
    description: "Commercial/Ventes",
    category: "business",
  },
  {
    code: "SUPPORT",
    name: "Support Client",
    description: "Support technique client",
    category: "support",
  },
  {
    code: "ADMIN",
      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              name: "DevOps",
              code: "ENG-DEVOPS",
              description: "CI/CD et Infrastructure",
            },
          ],
        },
        {
      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              name: "International",
              code: "BIZ-INT",
              description: "Marchés internationaux",
            },
          ],
        },
        {
...
const EMPLOYEES: EmployeeSeed[] = [
  // Engineering - Backend
  {
    first_name: "Thomas",
    last_name: "Martin",
    email: "thomas.martin@signapps.io",
  ...
  },
  {
    first_name: "Sophie",
    last_name: "Bernard",
    email: "sophie.bernard@signapps.io",
  ...
  },
  {
    first_name: "Lucas",
    last_name: "Dubois",
    email: "lucas.dubois@signapps.io",
  ...
  },
  {
    first_name: "Nathan",
    last_name: "Laurent",
    email: "nathan.laurent@signapps.io",
  ...
  },
  {
    first_name: "Chloé",
    last_name: "Michel",
    email: "chloe.michel@signapps.io",
  ...
  // Engineering - DevOps
  {
    first_name: "Maxime",
    last_name: "Garcia",
    email: "maxime.garcia@signapps.io",
  ...
  },
  {
    first_name: "Camille",
    last_name: "Roux",
    email: "camille.roux@signapps.io",
  ...
  // Engineering - Design
  {
    first_name: "Julie",
    last_name: "Fournier",
    email: "julie.fournier@signapps.io",
  ...
  },
  {
    first_name: "Antoine",
    last_name: "Girard",
    email: "antoine.girard@signapps.io",
  ...
  // Engineering - QA
  {
    first_name: "Marine",
    last_name: "Bonnet",
    email: "marine.bonnet@signapps.io",
  ...
  },
  {
    ...
    last_name: "Dupont",
    email: "alexandre.dupont@signapps.io",
  ...
  // Product
  {
    first_name: "Pauline",
    last_name: "Robert",
    email: "pauline.robert@signapps.io",
    employee_number: "EMP-015",
    org_code: "ENG-PRODUCT",
    functions: ["PM"],
    contract_type: "full-time",
    fte_ratio: 1,
  ...
  // Support N1
  {
    first_name: "Romain",
    last_name: "Petit",
    email: "romain.petit@signapps.io",
  ...
  },
  {
    first_name: "Clara",
    last_name: "Durand",
    email: "clara.durand@signapps.io",
  ...
  },
  {
    first_name: "Théo",
    last_name: "Lemoine",
    email: "theo.lemoine@signapps.io",
  ...
  // Support N2
  {
    first_name: "Manon",
    last_name: "Mercier",
    email: "manon.mercier@signapps.io",
    employee_number: "EMP-019",
    org_code: "OPS-N2",
    functions: ["SUPPORT", "DEV"],
    contract_type: "full-time",
    fte_ratio: 1,
  ...
  // Admin
  {
    first_name: "Isabelle",
    last_name: "Faure",
    email: "isabelle.faure@signapps.io",
  ...
  // Sales France
  {
    first_name: "Pierre",
    last_name: "Andre",
    email: "pierre.andre@signapps.io",
  ...
  },
  {
    first_name: "Julien",
    last_name: "Gauthier",
    email: "julien.gauthier@signapps.io",
  ...
  // Sales International
  {
    first_name: "Sarah",
    last_name: "Meyer",
    email: "sarah.meyer@signapps.io",
    employee_number: "EMP-024",
    org_code: "BIZ-INT",
    functions: ["SALES"],
    contract_type: "full-time",
    fte_ratio: 1,
  ...
  // HR
  {
    first_name: "Caroline",
    last_name: "Vincent",
    email: "caroline.vincent@signapps.io",
...
async function seed() {
  ...
  async function createNode(node: OrgNodeSeed, parentId?: string) {
    try {
      ...
      if (msg.includes("409") || msg.includes("already exists")) {
        ...
        try {
          const existing = await api<{ data: { id: string; code: string }[] }>(
            "/org?code=" + node.code,
          );
          if (existing.data?.[0]) {
  ...
  try {
    const tree = await api<{ data: Record<string, unknown>[] }>(
      "/org/tree?max_depth=10",
    );
    function collectIds(nodes: Record<string, unknown>[]) {
      for (const node of nodes) {
        if (node.code) nodeIdByCode[node.code as string] = node.id as string;
        if (node.children)
          collectIds(node.children as Record<string, unknown>[]);
      }
    }
    ...
    console.log(
      `  ✗ Failed to fetch tree: ${e instanceof Error ? e.message : String(e)}`,
    );
  }
  ...
  for (const emp of EMPLOYEES) {
    ...
    if (!orgNodeId) {
      console.log(
        `  ✗ ${emp.first_name} ${emp.last_name}: org node ${emp.org_code} not found`,
      );
      continue;
    }
    ...
    try {
      ...
      if (msg.includes("409") || msg.includes("already exists")) {
        ...
        console.log(`  ✗ ${emp.first_name} ${emp.last_name}: ${msg}`);
      }
    }
  }
  ...
  for (const template of COVERAGE_TEMPLATES) {
    ...
    if (!orgNodeId) {
      console.log(
        `  ✗ ${template.name}: org node ${template.org_code} not found`,
      );
      continue;
    }
