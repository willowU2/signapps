  ...
  const [emails, setEmails] = useState<EmailItem[]>([
    {
      ...
      summary:
        "Budget review scheduled for March 28th. Please prepare Q1 financial reports.",
      priority: "high",
      isRead: false,
    },
    {
      ...
      summary:
        "New marketing campaign launches Monday with 40% budget increase allocated.",
      priority: "medium",
      isRead: false,
    },
    {
      ...
      summary:
        "Team event confirmed for April 5th at Blue River Resort. RSVP required by Friday.",
      priority: "low",
      isRead: true,
    },
    {
      ...
      summary:
        "Security patch urgent: Update system within 24 hours to prevent vulnerabilities.",
      priority: "high",
      isRead: false,
    },
    {
      ...
      summary:
        "Invoice INV-2026-0415 for $2,450 is ready for review and approval.",
      priority: "medium",
      isRead: true,
    },
  ]);
        ...
        <CardContent className="space-y-6">
          ...
          <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-xs text-blue-900">
              <span className="font-semibold">Tip:</span> AI-powered summaries
              are generated from email content. Mark emails as read to remove
              them from your priority view.
            </p>
          </div>
        </CardContent>
      </Card>
