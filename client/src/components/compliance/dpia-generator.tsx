...
export function DpiaGenerator() {
  ...
  function toggleArray(
    key: "data_categories" | "data_subjects",
    value: string,
  ) {
    setData((p) => {
      const arr = p[key];
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) => update("data_controller", e.target.value)}
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              rows={3}
              placeholder="Describe the project and its data processing activities…"
            />
          </div>
        </div>
      )}
        ...
        <div className="space-y-3">
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              rows={2}
              placeholder="Why is the data being processed?"
            />
          </div>
          <div className="space-y-1.5">
            ...
            >
              {LEGAL_BASES.map((basis) => (
                <div key={basis} className="flex items-center space-x-2">
                  ...
                  <label htmlFor={basis} className="text-xs cursor-pointer">
                    {basis}
                  </label>
                </div>
              ))}
      ...
      {step === 2 && (
        <div className="space-y-3">
          <div className="space-y-1.5">
            ...
            <Textarea
              value={data.necessity_proportionality}
              onChange={(e) =>
                update("necessity_proportionality", e.target.value)
              }
              rows={3}
              placeholder="Is the processing necessary? Is it proportionate to the purpose?"
            />
          </div>
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              rows={2}
              placeholder="Encryption, access controls, pseudonymization…"
            />
          </div>
          <div className="space-y-1.5">
            ...
            <RadioGroup
              ...
              onValueChange={(v) =>
                update("risk_level", v as DpiaData["risk_level"])
              }
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              value={data.risks_identified}
              onChange={(e) => update("risks_identified", e.target.value)}
              rows={2}
              placeholder="List specific risks to data subjects…"
            />
          </div>
        </div>
      )}
        ...
        <div className="space-y-3">
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              onChange={(e) => update("mitigation_measures", e.target.value)}
              rows={4}
              placeholder="How will the identified risks be mitigated?"
            />
          </div>
          <div className="space-y-1.5">
            ...
            <RadioGroup
              ...
              onValueChange={(v) =>
                update("residual_risk", v as DpiaData["residual_risk"])
              }
              className="flex gap-4"
            >
              <div className="flex items-center gap-2">
                <RadioGroupItem value="acceptable" id="res-acc" />
                <label htmlFor="res-acc" className="text-sm cursor-pointer">
                  Acceptable
                </label>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              value={data.dpo_advice}
              onChange={(e) => update("dpo_advice", e.target.value)}
              rows={2}
            />
          </div>
        </div>
      ...
      {step === 4 && (
        <div className="space-y-3">
          {data.residual_risk === "unacceptable" && (
            <div className="flex items-center gap-2 rounded-md border border-destructive p-3 bg-destructive/5">
              ...
              <p className="text-sm text-destructive">
                Residual risk is unacceptable. Consult supervisory authority
                before proceeding.
              </p>
            </div>
          )}
          <div className="space-y-1.5">
            ...
            <RadioGroup
              value={data.proceed ? "yes" : "no"}
              onValueChange={(v) => update("proceed", v === "yes")}
              className="flex gap-4"
            >
              <div className="flex items-center gap-2">
