...
export function DigitalSignage() {
  ...
  useEffect(() => {
    setScreens([
      { id: "s1", name: "Lobby Screen", location: "Main Entrance", status: "online", currentContent: "Welcome Video.mp4" },
      { id: "s2", name: "Conference Room A", location: "Floor 2", status: "online", currentContent: "Meeting Agenda.pptx" },
      { id: "s3", name: "Cafeteria Display", location: "Cafeteria", status: "offline", currentContent: "Menu Board.mp4" },
    ]);
    setPlaylist([
        ...
        <div className="border rounded-lg p-4 bg-white">
          ...
          <div className="bg-gray-900 rounded w-full h-64 flex items-center justify-center">
            <p className="text-gray-400">
              {screens.find((s) => s.id === selectedScreen)?.currentContent || "No content"}
            </p>
          </div>
        </div>
      )}
