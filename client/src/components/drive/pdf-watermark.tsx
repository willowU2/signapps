...
export function WatermarkBadge({
  ...
  return (
    <div
      className={`flex items-center gap-2 p-2.5 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg ${className}`}
    >
      ...
      <div>
        ...
        <p className="text-[11px] text-amber-700 dark:text-amber-300 mt-0.5">
          &ldquo;CONFIDENTIEL — {username} — {today}&rdquo; sera ajouté en
          diagonale
        </p>
      </div>
    </div>
