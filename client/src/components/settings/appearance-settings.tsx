    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Choisissez l'apparence de SignApps adaptée à votre environnement de
            travail.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl">
            {themes.map((t) => {
              ...
              return (
                ...
                >
                  <Icon
                    className={`w-8 h-8 mb-3 ${isActive ? "text-primary" : "text-muted-foreground"}`}
                  />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Améliorez le contraste pour une meilleure lisibilité.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center justify-between max-w-md">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">
                Renforce les bordures et les couleurs pour améliorer la
                lisibilité.
              </p>
            </div>
            <Switch
