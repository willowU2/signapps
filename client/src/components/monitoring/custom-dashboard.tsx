    ...
    <Card>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            <DialogTitle>Add Chart Widget</DialogTitle>
          </DialogHeader>
          <div className="space-y-3 py-1">
            ...
            <div className="space-y-1.5">
              ...
              <Select
                value={form.metric}
                onValueChange={(v) =>
                  setForm((f) => ({ ...f, metric: v as MetricKey }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setForm((f) => ({ ...f, chartType: v as ChartType }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
          ...
          <DialogFooter>
            ...
            <Button onClick={addWidget} disabled={!form.title.trim()}>
              Add Widget
            </Button>
          </DialogFooter>
        </DialogContent>
