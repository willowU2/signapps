...
export const ProgressBarBase = ({ value, min = 0, max = 100, className, progressClassName }: ProgressBarProps) => {
    ...
    return (
        <div
            ...
            aria-valuemin={min}
            aria-valuemax={max}
            className={cx("h-2 w-full overflow-hidden rounded-md bg-zinc-100 dark:bg-zinc-800", className)}
        >
            <div
                // Use transform instead of width to avoid layout thrashing (and for smoother animation)
                style={{ transform: `translateX(-${100 - percentage}%)` }}
                className={cx("size-full rounded-md bg-zinc-800 dark:bg-zinc-200 transition duration-75 ease-linear", progressClassName)}
            />
        </div>
    );
};
            ...
            return (
                <div className="relative flex flex-col items-end gap-2">
                    ...
                    <div
                        ...
                        className="absolute -top-2 -translate-x-1/2 -translate-y-full rounded-lg bg-zinc-800 dark:bg-zinc-200_alt px-3 py-2 shadow-lg ring-1 ring-secondary_alt"
                    >
        ...
        case "bottom-floating":
            return (
                <div className="relative flex flex-col items-end gap-2">
                    ...
                    <div
                        style={{ left: `${percentage}%` }}
                        className="absolute -bottom-2 -translate-x-1/2 translate-y-full rounded-lg bg-zinc-800 dark:bg-zinc-200_alt px-3 py-2 shadow-lg ring-1 ring-secondary_alt"
                    >
