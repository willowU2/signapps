...
export const ProgressBarBase = ({
  ...
  return (
    <div
      ...
      aria-valuemax={max}
      className={cx(
        "h-2 w-full overflow-hidden rounded-md bg-zinc-100 dark:bg-zinc-800",
        className,
      )}
    >
      <div
        ...
        className={cx(
          "size-full rounded-md bg-zinc-800 dark:bg-zinc-200 transition duration-75 ease-linear",
          progressClassName,
        )}
      />
    </div>
