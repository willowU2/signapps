  ...
  const [templates] = useState<DayTemplate[]>([
    {
      ...
      blocks: ['Morning Focus (9-12)', 'Lunch Break', 'Afternoon Focus (1-5)', 'Admin Tasks'],
    },
    {
      id: '2',
      name: 'Meeting Heavy',
      ...
      blocks: ['Client Call A', 'Prep Time', 'Client Call B', 'Followup', 'Planning'],
    },
    {
      id: '3',
    ...
    },
    {
      ...
      blocks: ['Weekly Review', 'Data Analysis', 'Next Week Plan', 'Goal Setting'],
    },
  ]);
        ...
        {selectedTemplate && (
          <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
            <p className="text-sm text-blue-900">
              Template <strong>{templates.find((t) => t.id === selectedTemplate)?.name}</strong> will be applied to
              today's calendar.
            </p>
          </div>
        )}
