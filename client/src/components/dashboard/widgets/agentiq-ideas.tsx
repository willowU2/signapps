...
export function AgentiqIdeasWidget({
  widget,
                        ...
                        colIdeas.map((idea) => (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1 flex-wrap">
                              <span
                                className={`text-[10px] px-1 py-0.5 rounded ${IMPACT_BADGE[idea.impact] ?? ""}`}
                              >
                                {idea.impact}
                              </span>
                              {idea.effort && (
                            ...
                            {idea.status === "proposed" && (
                              <div className="flex gap-1 mt-1.5">
                                <Button
                                  ...
                                  onClick={() =>
                                    handleDecide(idea.id, "validated")
                                  }
                                  title="Valider"
                                >
