...
const DEFAULT_FAVORITES: FavoriteItem[] = [
  { id: '1', name: 'Rapport trimestriel Q1', type: 'file', path: '/documents/rapports/q1-2026.pdf' },
  { id: '2', name: 'Dossier Marketing', type: 'folder', path: '/documents/marketing' },
  { id: '3', name: 'Dashboard Analytics', type: 'link', path: '/admin/monitoring' },
  { id: '4', name: 'Budget previsionnel', type: 'file', path: '/documents/finance/budget-2026.xlsx' },
    ...
    <Card className="h-full">
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          ...
          <Button variant="ghost" size="sm" className="h-6 w-6 p-0" onClick={() => setAdding(!adding)}>
      ...
      <CardContent className="space-y-1">
        {adding && (
          <div className="flex gap-1 mb-2">
            ...
            />
            <Button size="sm" className="h-7 text-xs px-2" onClick={addFavorite}>OK</Button>
          </div>
        )}
        {favorites.map((fav) => {
