...
import { Lock, GitMerge, ArrowRight } from "lucide-react"

export function ETLPipelineStub() {
        ...
        <Card className="p-8 border-dashed">
            <div className="flex flex-col items-center justify-center gap-6">
                <div className="p-4 bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-950 dark:to-blue-950 rounded-lg">
                    <GitMerge className="w-8 h-8 text-indigo-600 dark:text-indigo-300" />
                </div>
                ...
                <p className="text-xs text-muted-foreground dark:text-gray-400 max-w-xs">
                    Extract, transform, and load data pipelines with real-time processing
                </p>
