...
export { LmsCourseToHrSkill, HrOnboardingTrigger, triggerHrOnboarding } from './lms-hr-bridge';

// Ideas 4, 19, 20: Supply chain / billing / accounting bridges
export { PoToInvoice, PaymentAccountingSync, AccountingToInvoice } from './supply-billing-bridge';

// Ideas 5, 6, 17: IT / HR / compliance / monitoring bridges
export { EmployeeAssetsPanel, ComplianceToLegalForm, MonitoringAlertToTicket } from './it-hr-compliance-bridge';

// Ideas 7, 13, 16: Meet / doc / slides bridges
export { MeetRecordingToDoc, SlidesToMeet, MeetAttendeeContacts } from './meet-doc-bridge';

// Ideas 8-9: Keep note conversions
export { NoteToDoc, NoteToTask } from './keep-convert';

// Ideas 10-12: Design exports + Sheets → CRM
export { DesignToSocialPost, DesignToEmailTemplate, SheetsToCrmReport } from './design-export-bridge';

// Ideas 14-15, 24: Chat share + task creation
export { ShareEntityToChat, ChatMessageToTask, FileShareToChat } from './chat-share-bridge';
...
export { CrossModuleContextMenu, useEmailToTaskDrop } from './context-menu-cross';

// Ideas 28, 33, 39: Linked entities + duplicate detection + smart links
export { LinkedEntitiesPanel, DuplicateDetector } from './linked-entities-panel';
...
export { DataSyncRules, PermissionInheritance, CrossModuleTemplates } from './data-sync-permissions';

// Ideas 37-38: Unified settings + analytics
export { UnifiedInteropSettings, CrossModuleAnalytics } from './unified-settings';
...
export { CrossModuleComments, ActivityDigestSettings } from './cross-module-comments';

// Ideas 46-47: Cross-module search + unified contacts
export { CrossModuleSearchBar, UnifiedContactCard } from './cross-module-search-filters';

// Ideas 48-49: Unified notifications + module health
export { CrossModuleNotificationCenter, ModuleHealthDashboard } from './unified-notifications';
