...
export function BillingForecast({ contactEmail }: Props) {
  ...
  const adjustedForecast = forecast.paymentRate > 0
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Card>
          <CardContent className="pt-4 pb-3">
            ...
            <p className="text-lg font-bold text-primary">{fmt(weightedForecast)}</p>
            <p className="text-xs text-muted-foreground mt-0.5">{activeDeals.length} deals actifs</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-4 pb-3">
        ...
        <Card>
          <CardContent className="pt-4 pb-3">
            <p className="text-xs text-muted-foreground">Taux paiement historique</p>
            <p className="text-lg font-bold text-emerald-600">{fmtPct(forecast.paymentRate)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-4 pb-3">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">× taux paiement</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="rounded-lg border bg-muted/30 px-3 py-2">
          <p className="text-xs text-muted-foreground">Deals gagnés (histor.)</p>
          <p className="text-sm font-bold">{forecast.wonDealsCount}</p>
        </div>
        <div className="rounded-lg border bg-muted/30 px-3 py-2">
          <p className="text-xs text-muted-foreground">Valeur moy. deal gagné</p>
