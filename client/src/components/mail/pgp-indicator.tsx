...
export function DecryptButton({
        ...
        return (
            <div className="flex items-center gap-2 p-3 rounded-lg border border-amber-200 dark:border-amber-800/50 bg-amber-50 dark:bg-amber-950/20 text-sm">
                ...
                <span className="text-amber-700 dark:text-amber-400">
                    This email is encrypted but you don&apos;t have a private
                    key configured to decrypt it.
                </span>
            </div>
        );
    }
    ...
    return (
        ...
        >
            <Lock className={`h-3.5 w-3.5 mr-1.5 ${decrypting ? "animate-pulse" : ""}`} />
                    ...
                    <PopoverContent className="w-80" align="start">
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                onChange={(e) =>
                                    onRecipientKeyChange(e.target.value)
                                }
                                placeholder="-----BEGIN PUBLIC KEY-----&#10;...&#10;-----END PUBLIC KEY-----"
                                className="font-mono text-[10px] h-32 resize-none"
                            />
                            <p className="text-[10px] text-muted-foreground">
                                Paste the recipient&apos;s public key to encrypt
                                the email. Only they will be able to read it.
                            </p>
                        </div>
                    </PopoverContent>
                </Popover>
...
export default PgpStatusBadges;
