...
export function SpamFilterEnhanced({
  accountId,
  onSensitivityChange,
}: SpamFilterEnhancedProps) {
  ...
  const getSensitivityLabel = (val: number) => {
    if (val < 30)
      return {
        label: "Permissive",
        desc: "Only obvious spam blocked",
        color: "text-green-600",
      };
    if (val < 60)
      return {
        label: "Balanced",
        desc: "Standard spam filtering",
        color: "text-blue-600",
      };
    if (val < 80)
      return {
        label: "Strict",
        desc: "Aggressive spam blocking",
        color: "text-amber-600",
      };
    return {
      label: "Maximum",
      desc: "Very aggressive — may catch legit emails",
      color: "text-red-600",
    };
  };
    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Adjust how aggressively spam is detected
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Manage trusted and blocked senders/domains
          </CardDescription>
        </CardHeader>
        <CardContent>
