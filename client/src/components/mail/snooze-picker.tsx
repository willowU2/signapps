...
const QUICK_OPTIONS = [
    ...
    { label: "Tomorrow 9 AM", getDate: () => setHours(addDays(startOfDay(new Date()), 1), 9) },
    ...
    { label: "Next week", getDate: () => setHours(addDays(startOfDay(new Date()), 7), 9) },
    { label: "In 2 weeks", getDate: () => setHours(addDays(startOfDay(new Date()), 14), 9) },
]

export function SnoozeDatePicker({ onSnooze, children }: SnoozeDatePickerProps) {
    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent align="end" className="w-72 p-0 rounded-xl shadow-xl border-border/50" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="p-3 border-t space-y-2">
                    <Label className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Custom</Label>
