...
export function UndoSendBanner({ subject, onCancel, onSent }: UndoSendBannerProps) {
...
export function UndoSendSettings({ enabled, delaySeconds, onToggle, onDelayChange }: UndoSendSettingsProps) {
  return (
