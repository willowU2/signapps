...
import { format, addHours, addDays, startOfDay, setHours, isBefore } from "date-fns"
...
export function ScheduleSendPopup({ onSchedule, disabled }: ScheduleSendPopupProps) {
    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent align="end" className="w-72 p-0 rounded-xl shadow-xl border-border/50">
                {/* Header */}
                <div className="p-3 border-b">
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">Pick when to send this email</p>
                </div>
                ...
                <div className="p-3 border-t space-y-3">
                    <Label className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Custom date & time</Label>
