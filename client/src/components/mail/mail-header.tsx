    ...
    <header className="h-16 shrink-0 flex items-center justify-between px-4 pr-6">
      <div className="flex items-center gap-4 w-[260px] shrink-0 relative z-20">
        ...
        <div className="flex items-center gap-2 px-2 select-none cursor-pointer">
          ...
          <span className="text-[22px] font-normal text-muted-foreground tracking-tight">
            Gmail
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-1 shrink-0 z-20">
        <Button
          variant="outline"
          size="sm"
          className="hidden lg:flex h-9 rounded-full border-border text-muted-foreground font-medium px-4 hover:bg-muted mr-2 gap-2"
        >
        ...
        <Button
          variant="ghost"
          size="icon"
          className="h-10 w-10 rounded-full text-muted-foreground hover:bg-muted ml-1"
        >
