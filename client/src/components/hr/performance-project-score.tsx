...
const PERF_LEVEL = (rate: number) =>
  rate >= 85
    ? { label: "Excellent", class: "bg-green-100 text-green-800" }
    : rate >= 70
      ? { label: "Bon", class: "bg-blue-100 text-blue-800" }
      : rate >= 55
        ? { label: "Moyen", class: "bg-yellow-100 text-yellow-800" }
...
const DEMO_DATA: EmployeeProjectPerformance[] = [
  {
    ...
    projectContributions: [
      { projectName: "Auth Backend", contribution: 68 },
      { projectName: "Analytics", contribution: 32 },
    ],
  },
  {
    employeeId: "2",
    ...
    trend: "stable",
    projectContributions: [
      { projectName: "Auth Backend", contribution: 50 },
      { projectName: "Infra", contribution: 50 },
    ],
  },
  {
    employeeId: "5",
    ...
    avgQualityScore: 4.1,
    trend: "down",
    projectContributions: [{ projectName: "Analytics", contribution: 100 }],
  },
];
...
export function PerformanceProjectScore({
  employees = DEMO_DATA,
}: PerformanceProjectScoreProps) {
          ...
          return (
            ...
            >
              ...
              >
                ...
                <Badge className={`text-[10px] shrink-0 ${level.class}`}>
                  {level.label}
                </Badge>
              </button>
              {isOpen && (
                <div className="border-t bg-muted/20 px-3 py-2 space-y-2 text-xs">
                  <div className="grid grid-cols-3 gap-2 text-center">
                    <div>
                      <p className="text-muted-foreground">Dans les délais</p>
                      <p className="font-bold">
                        {emp.onTimeDeliveries}/{emp.totalDeliveries}
                      </p>
                    </div>
                    <div>
                      <p className="text-muted-foreground">Qualité moy.</p>
                      <p className="font-bold">{emp.avgQualityScore}/5</p>
                    </div>
                    <div>
