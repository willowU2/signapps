...
const BASE_DATA: DeptPayroll[] = [
  { department: "Technologie", headcount: 8, avgGross: 4200, totalGross: 33600, employeeCharges: 7728, employerCharges: 14112, netTotal: 25872, totalCost: 47712 },
  { department: "Commercial", headcount: 5, avgGross: 3600, totalGross: 18000, employeeCharges: 4140, employerCharges: 7560, netTotal: 13860, totalCost: 25560 },
  { department: "Finance", headcount: 3, avgGross: 3900, totalGross: 11700, employeeCharges: 2691, employerCharges: 4914, netTotal: 9009, totalCost: 16614 },
  { department: "RH", headcount: 2, avgGross: 3700, totalGross: 7400, employeeCharges: 1702, employerCharges: 3108, netTotal: 5698, totalCost: 10508 },
  { department: "Direction", headcount: 2, avgGross: 7500, totalGross: 15000, employeeCharges: 3450, employerCharges: 6300, netTotal: 11550, totalCost: 21300 },
];
...
export function PayrollSimulationReport() {
  ...
  }), { headcount: 0, totalGross: 0, employeeCharges: 0, employerCharges: 0, netTotal: 0, totalCost: 0 });
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <div className="rounded-lg border bg-green-50 p-4">
          ...
          <p className="text-xl font-bold text-green-900">{fmt(totals.netTotal)}</p>
        </div>
        <div className="rounded-lg border bg-purple-50 p-4">
          <div className="flex items-center gap-2 mb-1"><TrendingUp className="w-4 h-4 text-purple-600" /><span className="text-xs text-purple-700 font-medium">Coût employeur</span></div>
          <p className="text-xl font-bold text-purple-900">{fmt(totals.totalCost)}</p>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y">
              ...
              <tr className="bg-gray-100 font-bold border-t-2">
                ...
                <td className="px-4 py-3 text-right text-red-700">{fmt(totals.employeeCharges)}</td>
                <td className="px-4 py-3 text-right text-green-700">{fmt(totals.netTotal)}</td>
                <td className="px-4 py-3 text-right text-orange-700">{fmt(totals.employerCharges)}</td>
                <td className="px-4 py-3 text-right text-purple-700 bg-purple-100">{fmt(totals.totalCost)}</td>
              </tr>
            </tbody>
          </table>
        </div>
