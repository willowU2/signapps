...
const EMPLOYEES: Employee[] = [
  ...
  },
  {
    ...
    email: "claire.bernard@signapps.io",
    phone: "+33 6 34 56 78 90",
    location: "Paris",
    status: "active",
    joinDate: "2021-01-10",
    skills: ["CRM", "Négociation", "Prospection"],
  },
  {
    id: "4",
    name: "David Petit",
    role: "Comptable",
    department: "Finance",
    email: "david.petit@signapps.io",
    phone: "+33 6 45 67 89 01",
    location: "Bordeaux",
    status: "active",
    joinDate: "2020-09-01",
    skills: ["Comptabilité", "Excel", "FEC"],
  },
  {
    id: "5",
    name: "Emma Leroy",
    ...
    status: "active",
    joinDate: "2024-01-15",
    skills: ["Figma", "Design System", "A/B Testing"],
  },
  {
    id: "6",
    ...
    role: "Support Client",
    department: "Commercial",
    email: "f.moreau@signapps.io",
    phone: "+33 6 67 89 01 23",
    location: "Nantes",
    status: "away",
    joinDate: "2023-06-01",
    skills: ["Helpdesk", "Zendesk", "Communication"],
  },
  {
    id: "7",
    name: "Nadia Rousseau",
    role: "RH Manager",
    department: "RH",
    email: "nadia.rousseau@signapps.io",
    phone: "+33 6 78 90 12 34",
    location: "Paris",
    status: "active",
    joinDate: "2019-04-01",
    skills: ["Recrutement", "SIRH", "Formation"],
  },
  {
    id: "8",
    name: "Marc Dubois",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Fiches employés avec photo, rôle, département et contact
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {filtered.map((emp) => (
          <div
            ...
            className="rounded-xl border bg-card p-4 cursor-pointer hover:shadow-md transition-shadow hover:border-blue-200"
          >
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="flex items-center gap-1.5">
                <div
                  className={`w-2 h-2 rounded-full ${STATUS_CONFIG[emp.status].color}`}
                />
            ...
            <div className="mt-3 pt-3 border-t flex gap-2">
              <a
                ...
                className="flex-1 flex items-center justify-center gap-1 text-xs text-blue-600 hover:text-blue-800 py-1 rounded hover:bg-blue-50"
              >
              ...
              <a
                href={`tel:${emp.phone}`}
                onClick={(e) => e.stopPropagation()}
                className="flex-1 flex items-center justify-center gap-1 text-xs text-muted-foreground hover:text-gray-800 py-1 rounded hover:bg-muted"
              >
          ...
          >
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <div
                        className={`w-2 h-2 rounded-full ${STATUS_CONFIG[selected.status].color}`}
                      />
                  ...
                  <button
                    onClick={() => setSelected(null)}
                    className="text-gray-400 hover:text-muted-foreground text-2xl leading-none"
                  >
                    &times;
                  </button>
                </div>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
              ...
              <div>
                ...
                <p className="font-medium">{selected.joinDate}</p>
              </div>
            </div>
            <div className="mt-4">
