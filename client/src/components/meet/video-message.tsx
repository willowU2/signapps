    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Enregistrez un message vidéo asynchrone</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          {recordingTime > 0 && !isRecording && (
            <Button onClick={sendVideoMessage} className="w-full gap-2 bg-green-600 hover:bg-green-700">
      ...
      {messages.length === 0 ? (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground text-center mt-2">Commencez à enregistrer des messages</p>
          </CardContent>
        </Card>
      ) : (
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {message.isNew && <Badge className="bg-blue-600">Nouveau</Badge>}
                    </div>
                  </div>
