...
export const AbsencePrediction: React.FC = () => {
  ...
  const teamCoverage: TeamMember[] = [
    {
      name: "Alice Johnson",
      predictedAbsenceDate: "2026-03-27",
      riskFactor: "high",
    },
    {
      name: "Bob Smith",
    ...
    {
      name: "Carol Davis",
      predictedAbsenceDate: "2026-03-30",
      riskFactor: "low",
    },
  ];
              ...
              <div className="flex justify-between items-start mb-2">
                ...
                <div className="text-right">
                  <p className="text-sm font-bold text-foreground">
                    {day.predictedAbsences} absence(s)
                  </p>
                </div>
              </div>
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <p
                    className={`text-xs font-bold ${getCoverageColor(day.coverage)}`}
                  >
                    {day.coverage}%
                  </p>
                </div>
            ...
            >
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {member.predictedAbsenceDate}
                  </p>
                </div>
                <span
                  className={`px-2 py-1 rounded text-xs font-semibold ${getRiskColor(member.riskFactor)}`}
                >
