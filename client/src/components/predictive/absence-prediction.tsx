...
export const AbsencePrediction: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow">
      ...
      <div className="mb-6">
        <h3 className="text-sm font-semibold text-gray-700 mb-3">Upcoming Absences</h3>
            ...
            <div key={day.date} className="p-3 border border-gray-200 rounded-lg">
              <div className="flex justify-between items-start mb-2">
                ...
                <div className="text-right">
                  <p className="text-sm font-bold text-gray-900">{day.predictedAbsences} absence(s)</p>
                </div>
              </div>
              <div>
                <div className="flex justify-between items-center mb-1">
                  <p className="text-xs text-gray-600">Team Coverage</p>
            ...
            <div key={idx} className="p-3 bg-gray-50 border border-gray-200 rounded-lg">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs text-gray-600">{member.predictedAbsenceDate}</p>
                </div>
