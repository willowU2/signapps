        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b bg-muted">
              ...
              <th className="px-4 py-3 text-left font-semibold text-muted-foreground">Current</th>
              <th className="px-4 py-3 text-left font-semibold text-muted-foreground">Ideal</th>
          ...
          <tbody>
            {products.map((product) => {
              ...
              return (
                <tr key={product.id} className="border-b hover:bg-muted transition">
                  <td className="px-4 py-3 font-medium text-foreground">{product.name}</td>
                  <td className="px-4 py-3">
                    <span className="text-foreground">{product.currentStock}</span>
                  </td>
                  <td className="px-4 py-3">
                    <span className="text-foreground">{product.idealStock}</span>
                  </td>
                  <td className="px-4 py-3">
