...
const SAMPLE: GlossaryTerm[] = [
  {
    ...
    term: "Workspace",
    locale: "fr",
    definition: "A collaborative space grouping users and resources",
  ...
  },
  {
    ...
    term: "Container",
    locale: "fr",
    definition: "Docker/Podman container instance",
    translation: "Conteneur",
    forbidden: false,
    domain: "Technical",
  },
];
...
export function GlossaryManager() {
  ...
  const save = () => {
    if (!form.term || !form.locale || !form.translation) {
      toast.error("Term, locale and translation required");
      return;
    }
          ...
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="flex items-center gap-2">
                <BookMarked className="h-5 w-5" /> Glossary Management
              </CardTitle>
              <CardDescription>
                Define approved terms and translations per language and domain
              </CardDescription>
            </div>
              ...
              >
                <div className="flex items-start gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p
                      className={`text-xs text-muted-foreground ${t.locale === "ar" || t.locale === "he" ? "text-right" : ""}`}
                      dir={
                        t.locale === "ar" || t.locale === "he" ? "rtl" : "ltr"
                      }
                    >
                      {t.translation}
                    </p>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              <Label>Approved Translation</Label>
              <Input
                ...
                dir={
                  form.locale === "ar" || form.locale === "he" ? "rtl" : "ltr"
                }
              />
            </div>
            <div className="space-y-1">
