            ...
            <div className="flex flex-col gap-1 text-center">
                <div className="flex justify-center gap-1 text-center">
                    ...
                    <label htmlFor={id} className="flex cursor-pointer">
                        <Button color="link-gray" size="md" isDisabled={isDisabled} onClick={() => inputRef.current?.click()}>
    ...
    return (
        <motion.li layout="position" className={cx("relative flex gap-3 overflow-hidden rounded-xl bg-background p-4", className)}>
            ...
            <div
                ...
                className={cx("absolute inset-0 size-full bg-muted transition duration-75 ease-linear", isComplete && "opacity-0")}
                role="progressbar"
