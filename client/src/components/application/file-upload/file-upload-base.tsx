        ...
        <div className="flex w-full max-w-full min-w-0 flex-1">
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-0.5 flex items-center gap-2">
              <p className="truncate text-sm whitespace-nowrap text-muted-foreground">
              ...
              <div className="flex items-center gap-1">
                {isComplete && (
                  <CheckCircle2 className="size-4 stroke-[2.5px] text-fg-success-primary" />
                )}
                {isComplete && (
                ...
                {!isComplete && !failed && (
                  <UploadCloud className="stroke-[2.5px size-4 text-fg-quaternary" />
                )}
                {!isComplete && !failed && (
...
export const FileListItemProgressFill = ({
  ...
  return (
    <motion.li
      layout="position"
      className={cx(
        "relative flex gap-3 overflow-hidden rounded-xl bg-background p-4",
        className,
      )}
    >
      {/* Progress fill. */}
      <div
        ...
        className={cx(
          "absolute inset-0 size-full bg-muted transition duration-75 ease-linear",
      ...
      <div
        className={cx(
          "absolute inset-0 size-full rounded-[inherit] ring-1 ring-border transition duration-100 ease-linear ring-inset",
          failed && "ring-2 ring-error",
        )}
      />
          ...
          <div className="w-full min-w-0 flex-1">
            ...
            <div className="mt-0.5 flex items-center gap-2">
              <p className="text-sm text-muted-foreground">
                {failed
                  ? "Échec du téléversement, please try again"
                  : getReadableFileSize(size)}
              </p>
              ...
              {!failed && (
                <>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {!isComplete && (
                      <UploadCloud className="size-4 stroke-[2.5px] text-fg-quaternary" />
                    )}
