...
export function AccessibilityProvider({
  ...
  useEffect(() => {
    ...
    if (lh)
      document.documentElement.style.setProperty("--a11y-line-height", lh);
    if (ls)
      document.documentElement.style.setProperty("--a11y-letter-spacing", ls);
    if (ws)
      document.documentElement.style.setProperty("--a11y-word-spacing", ws);
