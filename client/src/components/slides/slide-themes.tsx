      ...
      <PopoverTrigger asChild>
        ...
        >
          <div
            ...
            style={{
              background: `linear-gradient(135deg, ${currentTheme.colors.primary} 50%, ${currentTheme.colors.accent} 50%)`,
            }}
          />
...
export function ThemePreview({ theme, size = "sm" }: ThemePreviewProps) {
  ...
  return (
    <div
      className={cn(
        dimensions,
        "rounded border border-border/50 overflow-hidden relative",
      )}
      style={{ backgroundColor: theme.colors.background }}
    >
      <div
