...
export function SlideSidebar({
  ...
  return (
    <div
      data-testid="slides-editor-thumbnails"
      className="flex flex-col h-full bg-muted/50 border-r border-border"
    >
        ...
        <div className="flex items-center gap-1">
          {onSaveToDrive && (
            <button
              ...
              className="p-1.5 hover:bg-green-100 rounded-md transition-colors text-muted-foreground hover:text-green-600"
          ...
          {onExportPPTX && (
            <button
              ...
              className="p-1.5 hover:bg-blue-100 rounded-md transition-colors text-muted-foreground hover:text-blue-600"
      ...
      <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-4 custom-scrollbar">
          ...
          return (
            ...
            >
              ...
              >
                <SlideThumbnail
                  slideId={slide.id}
                  presentationId="demo-presentation-1"
                />
                ...
                <div className="absolute top-1 right-1 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                  {onDuplicateSlide && (
                    <button
                      ...
                      className="p-1.5 bg-background/80 hover:bg-indigo-50 hover:text-indigo-600 text-muted-foreground rounded-md backdrop-blur-sm shadow-sm transition-colors"
                  ...
                  {slides.length > 1 && (
                    <button
                      ...
                      className="p-1.5 bg-background/80 hover:bg-rose-50 hover:text-rose-600 text-muted-foreground rounded-md backdrop-blur-sm shadow-sm transition-colors"
        ...
        {slides.length > 0 && (
          <div
            data-testid="slides-editor-add-slide"
          ...
          >
            ...
            {/* Add Slide Tile */}
            <div className="flex-1 aspect-video rounded-lg border-2 border-dashed border-border hover:border-indigo-400 hover:bg-indigo-50/50 transition-all flex flex-col items-center justify-center text-muted-foreground hover:text-indigo-600 bg-background/50 group-hover:shadow-sm">
              <Plus className="w-6 h-6 mb-1 opacity-70 group-hover:opacity-100" />
              <span className="text-xs font-medium opacity-80 group-hover:opacity-100 mt-1">
        ...
        {slides.length === 0 && (
          <div className="flex flex-col items-center justify-center h-32 text-center text-sm text-gray-400">
            ...
            <button
              data-testid="slides-editor-add-slide"
              onClick={() => onAddSlide("title_slide")}
              className="mt-2 text-indigo-600 font-medium text-xs hover:underline"
            >
