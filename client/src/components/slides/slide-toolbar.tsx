...
export function SlideToolbar({
  ...
  return (
    <Toolbar
      data-testid="slides-editor-toolbar"
    ...
    >
      ...
      <ToolbarGroup>
        ...
        {onToggleSmartGuides !== undefined && (
          <ToolbarButton
            ...
            isActive={smartGuidesEnabled}
            title="Guides intelligents"
          >
      ...
      <ToolbarGroup>
        <ToolbarButton
          ...
          isActive={isFormatPainting}
          title="Reproduire le format"
        >
      ...
      <ToolbarGroup className="hidden sm:flex">
        ...
        {onToggleMasterEditor && (
          <ToolbarButton
            ...
            isActive={showMasterEditor}
            title="Modeles de diapositives"
          >
      ...
      <ToolbarGroup className="ml-auto gap-1">
        ...
        {onStartLivePresentation && (
          <ToolbarButton
            onClick={onStartLivePresentation}
            title="Presentation en direct"
          >
