...
const INITIAL_CARDS: KanbanCard[] = [
  ...
  {
    id: "2",
    title: "Créer les migrations SQL",
    assignee: "MR",
    priority: "medium",
    dueDate: "2026-03-30",
    column: "todo",
  ...
  {
    id: "5",
    title: "Tests d'intégration Axum",
    assignee: "MR",
    priority: "high",
    dueDate: "2026-03-27",
    column: "review",
  ...
  return (
    <>
      <div className="flex h-full w-full gap-4 overflow-x-auto p-4 bg-black/[0.02]">
        {COLUMNS.map((col, colIndex) => {
          ...
          return (
            <div
              key={col.id}
              className="w-72 flex-shrink-0 flex flex-col bg-background/50 border rounded-xl overflow-hidden shadow-sm"
            >
              {/* Column header */}
      ...
      <Dialog open={showAddCard} onOpenChange={setShowAddCard}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Titre de la carte</DialogTitle>
          </DialogHeader>
          <Input
            value={newCardTitle}
