...
const TODAY_TASKS: WorkspaceTask[] = [
  {
    id: "t1",
    title: "Implémenter endpoint POST /auth",
    assignee: "Alice",
    dueDate: "2026-03-29",
    priority: "high",
    status: "in_progress",
    projectName: "Backend Auth",
  },
  {
    id: "t2",
    title: "Review PR #42",
...
const TODAY_EVENTS: WorkspaceEvent[] = [
  ...
  },
  {
    ...
    time: "14:00",
    type: "review",
    participants: ["Alice", "Emma", "Bob", "Marc"],
  },
  {
    id: "e3",
    title: "Emma Leroy — Congé",
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          <div className="rounded-lg bg-green-50 p-2 text-center">
            ...
            <p className="text-sm font-bold text-green-700">
              {MEMBERS.filter((m) => m.status !== "leave").length}
            </p>
              ...
              {MEMBERS.map((m) => (
                <div key={m.id} className="flex items-center gap-2.5">
                  ...
                  {m.status !== "leave" ? (
                    ...
                    <Badge
                      variant="outline"
                      className="text-[10px] h-4 text-orange-600"
                    >
                      Absent
                    </Badge>
                  )}
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-1 mt-0.5">
                      {ev.participants.map((p) => (
                        <span
                          key={p}
                          className="text-[10px] rounded-full bg-muted px-1.5 py-0.5"
                        >
                          {p}
                        </span>
                      ))}
