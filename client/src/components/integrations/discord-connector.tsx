    ...
    try {
      await fetch(wh.webhook_url, {
        ...
        body: JSON.stringify({
          ...
          content: "Test notification from SignApps",
        }),
      });
    ...
    setWebhooks((ws) =>
      ws.map((w) =>
        w.id === id
          ? {
              ...w,
              events: w.events.includes(ev)
                ? w.events.filter((e) => e !== ev)
                : [...w.events, ev],
            }
          : w,
      ),
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Send SignApps notifications to Discord channels via webhooks
          </CardDescription>
        </CardHeader>
