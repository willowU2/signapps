...
export function N8nConnector() {
  ...
  const testConnection = async () => {
    ...
    setWorkflows([
      {
        id: "wf1",
        name: "SignApps → Notion Sync",
        active: true,
        webhook_url: `${n8nUrl}/webhook/signapps-notion`,
      },
      {
        id: "wf2",
        name: "New User Onboarding",
        active: false,
        webhook_url: `${n8nUrl}/webhook/user-onboarding`,
      },
      {
        id: "wf3",
        name: "Daily Report Generator",
        active: true,
        webhook_url: `${n8nUrl}/webhook/daily-report`,
      },
    ]);
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Workflow className="h-5 w-5" /> n8n Workflow Integration
          </CardTitle>
          <CardDescription>
            Connect to a local or remote n8n instance to trigger and manage
            workflows
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm">
              {connected ? "Connecté" : "Not connected"}
            </span>
            {connected && (
