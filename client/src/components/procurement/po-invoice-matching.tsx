        ...
        <CardContent className="space-y-6">
          {!showComparison ? (
            ...
            <div className="space-y-6">
              ...
              {!isApproved ? (
                <Button onClick={handleApprove} className="w-full bg-green-600 hover:bg-green-700" disabled={!!approvingId}>
                  {approvingId ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <CheckCircle2 className="h-4 w-4 mr-2" />}
                  Approve for Payment
                </Button>
              ) : (
              ...
              <Button onClick={handleLoadData} variant="outline" className="w-full" disabled={isLoading}>
