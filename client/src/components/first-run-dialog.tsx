...
export function FirstRunDialog() {
  ...
  const handleSeed = useCallback(async () => {
    ...
    const initialSteps: SeedStep[] = [
      ...
      {
        id: "calendar",
        label: "Evenements du calendrier",
    ...
    try {
      ...
      try {
        const demoUsers = [
          {
            ...
            email: "marie.dupont@signapps.local",
          ...
          },
          {
            ...
            email: "jean.martin@signapps.local",
        ...
        updateStep("users", {
          status: "done",
          detail: `${created} utilisateurs crees`,
        });
      } catch {
        updateStep("users", {
          status: "error",
      ...
      try {
        const contacts = [
          {
            display_name: "Sophie Lefevre",
            email: "sophie.lefevre@acme.fr",
          ...
          },
          {
            ...
            email: "isabelle.moreau@durand.fr",
            phone: "+33 6 34 56 78 90",
            company: "Durand & Associes",
            job_title: "Avocate",
          },
          {
            display_name: "Nicolas Petit",
            email: "nicolas.petit@innovatech.fr",
          ...
          },
          {
            ...
            email: "camille.roux@mediaplus.fr",
          ...
          },
          {
            ...
            email: "antoine.dubois@construire.fr",
            phone: "+33 6 67 89 01 23",
            company: "Construire SA",
            job_title: "Architecte",
          },
          {
            display_name: "Emilie Laurent",
            email: "emilie.laurent@santeplus.fr",
            phone: "+33 6 78 90 12 34",
            company: "SantePlus",
            job_title: "Medecin",
          },
          {
            display_name: "Pierre Girard",
            email: "pierre.girard@logisys.fr",
            phone: "+33 6 89 01 23 45",
            company: "LogiSys",
            job_title: "Administrateur Systeme",
          },
          {
            display_name: "Julie Bonnet",
            email: "julie.bonnet@creativ.fr",
            phone: "+33 6 90 12 34 56",
            company: "Creativ Agency",
            job_title: "Designer UX",
          },
          {
            display_name: "Francois Lemaire",
            email: "francois.lemaire@finance.fr",
        ...
        if (contactsHealth.healthy) {
          ...
          updateStep("contacts", {
            status: "done",
            detail: `${created} contacts crees`,
          });
        } else {
          // Save to localStorage for offline/no-service mode
          localStorage.setItem(
            "signapps_demo_contacts",
            JSON.stringify(contacts),
          );
          updateStep("contacts", {
            status: "done",
            detail: "10 contacts (local)",
          });
        }
      } catch {
        updateStep("contacts", {
          ...
          if (calendarId) {
            ...
            const events = [
              ...
              },
              {
                ...
                description: "Demo des nouvelles fonctionnalites",
                color: "#0b8043",
              },
              {
                ...
                description: "Discussion renouvellement contrat",
                color: "#f4511e",
              },
              {
                title: "Formation IA",
                ...
                description: "Session sur les outils IA integres",
                color: "#8e24aa",
              },
              {
                title: "Point projet",
                ...
                description: "Revue avancement et risques",
                color: "#f6bf26",
              },
            ];
            ...
            updateStep("calendar", {
              status: "done",
              detail: `${created} evenements crees`,
            });
          } else {
            updateStep("calendar", {
              status: "error",
              detail: "Impossible de creer le calendrier",
            });
          }
        }
      } catch {
        ...
        if (!schedHealth.healthy) {
          ...
          const jobs = [
            ...
            },
            {
              ...
              description:
                "Suppression des logs de plus de 30 jours, chaque dimanche",
              target_type: "host" as const,
              enabled: true,
            },
          ];
      ...
      try {
        ...
        if (!storHealth.healthy) {
          ...
          updateStep("storage", {
            status: "done",
            detail: `${created} documents crees`,
          });
        }
      } catch {
        updateStep("storage", {
        ...
        <DialogHeader>
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              ...
              <DialogDescription>
                {seedStatus === "idle" &&
                  "C'est votre premiere utilisation. Souhaitez-vous initialiser l'application avec des donnees de demonstration ?"}
