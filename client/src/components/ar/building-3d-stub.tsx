...
export function Building3dStub() {
  const [isHovered, setIsHovered] = useState(false);

  return (
    <Card className="p-8 border-dashed">
      <div className="flex flex-col items-center justify-center gap-6">
        <div className="p-4 bg-gradient-to-br from-slate-50 to-gray-50 dark:from-slate-950 dark:to-gray-950 rounded-lg">
        ...
        <p className="text-xs text-muted-foreground dark:text-gray-400 max-w-xs">
          Visualize and navigate 3D building layouts and floor plans
        </p>
