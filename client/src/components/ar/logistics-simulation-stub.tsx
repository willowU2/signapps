...
export function LogisticsSimulationStub() {
    const [isHovered, setIsHovered] = useState(false)

    return (
        <Card className="p-8 border-dashed">
            <div className="flex flex-col items-center justify-center gap-6">
                <div className="p-4 bg-gradient-to-br from-teal-50 to-green-50 dark:from-teal-950 dark:to-green-950 rounded-lg">
                    <Truck className="w-8 h-8 text-teal-600 dark:text-teal-300" />
                </div>
                ...
                <p className="text-xs text-muted-foreground dark:text-gray-400 max-w-xs">
                    3D visualization of logistics flows and supply chain networks
                </p>
