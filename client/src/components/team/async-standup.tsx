    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Partagez votre progression avec l'équipe. Cela prend environ 2-3
            minutes.
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Qu'avez-vous accompli hier ?"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Y a-t-il quelque chose qui vous bloque ? (Optionnel)"
      ...
      <div>
        <h2 className="text-xl font-bold mb-4">
          Standups de l'Équipe d'Aujourd'hui
        </h2>
        {standups.length === 0 ? (
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground text-center">
                Aucun standup soumis pour aujourd'hui.
              </p>
            </CardContent>
          </Card>
        ) : (
