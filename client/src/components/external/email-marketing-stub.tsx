...
export function EmailMarketingStub() {
        ...
        <Card className="p-8 border-dashed">
            <div className="flex flex-col items-center justify-center gap-6">
                <div className="p-4 bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950 dark:to-amber-950 rounded-lg">
                    <Mail className="w-8 h-8 text-orange-600 dark:text-orange-300" />
                </div>
                ...
                <p className="text-xs text-muted-foreground dark:text-gray-400 max-w-xs">
                    Create and manage email campaigns with templates, automation, and analytics
                </p>
