...
function getPctBadge(pct: number): React.ReactNode {
  ...
  if (pct >= 80)
    return (
      <Badge className="bg-yellow-100 text-yellow-700">Proche limite</Badge>
    );
        ...
        <div>
          <div className="flex justify-between text-sm mb-1">
            <span className="font-medium">
              {line.spent.toLocaleString("fr")} €
            </span>
            <span className="text-muted-foreground">
              / {line.allocated.toLocaleString("fr")} €
            </span>
          </div>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold">
              {summary.totalAllocated.toLocaleString("fr")} €
            </p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold">
              {summary.totalSpent.toLocaleString("fr")} €
            </p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            ...
            <p
              className={`text-2xl font-bold ${summary.overBudget > 0 ? "text-destructive" : "text-green-600"}`}
            >
              {summary.overBudget}
            </p>
          </CardContent>
