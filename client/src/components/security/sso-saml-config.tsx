        ...
        <CardContent className="space-y-5">
          <div className="rounded-lg bg-muted/50 p-4 space-y-3">
            <p className="text-sm font-medium">
              Service Provider (SP) URLs — provide these to your IdP
            </p>
            <div className="space-y-2">
              {[
                ...
                <div key={label} className="flex items-center gap-2">
                  ...
                  <code className="flex-1 text-xs bg-background border rounded px-2 py-1 font-mono truncate">
                    {value}
                  </code>
                  <Button
                    size="icon"
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setConfig((c) => ({ ...c, idp_entity_id: e.target.value }))
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setConfig((c) => ({ ...c, idp_sso_url: e.target.value }))
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                placeholder="email"
                value={config.attribute_mapping_email}
                onChange={(e) =>
                  setConfig((c) => ({
                    ...c,
                    attribute_mapping_email: e.target.value,
                  }))
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                value={config.attribute_mapping_name}
                onChange={(e) =>
                  setConfig((c) => ({
                    ...c,
                    attribute_mapping_name: e.target.value,
                  }))
                }
              />
            </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) =>
                setConfig((c) => ({ ...c, idp_certificate: e.target.value }))
              }
          ...
          <div className="flex items-center gap-3">
            <Switch
              checked={config.force_authn}
              onCheckedChange={(v) =>
                setConfig((c) => ({ ...c, force_authn: v }))
              }
            />
            <div>
              <Label>Force Re-authentication</Label>
              <p className="text-xs text-muted-foreground">
                Always re-authenticate with IdP even if session exists
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-2">
            <Button
              variant="outline"
              onClick={handleTest}
              disabled={testing || !config.idp_sso_url}
            >
              <RefreshCw
