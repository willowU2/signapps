...
export default function ProductRoadmap() {
  ...
  const roadmapItems: RoadmapItem[] = [
    { id: "1", name: "Foundation", type: "release", start: 0, duration: 8, teams: ["Backend", "Frontend"], status: "completed" },
    { id: "2", name: "Core Features", type: "epic", start: 2, duration: 15, teams: ["Backend", "Frontend", "QA"], status: "in-progress" },
    { id: "3", name: "Mobile Optimization", type: "epic", start: 10, duration: 12, teams: ["Frontend", "Mobile"], status: "planned" },
    { id: "4", name: "v1.0 Release", type: "release", start: 8, duration: 3, teams: ["All"], status: "in-progress" },
    { id: "5", name: "Analytics Dashboard", type: "epic", start: 15, duration: 10, teams: ["Backend", "Frontend"], status: "planned" },
    { id: "6", name: "API Stability", type: "epic", start: 20, duration: 8, teams: ["Backend", "DevOps"], status: "planned" },
  ];
