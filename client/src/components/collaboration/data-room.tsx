          ...
          {documents.map((doc) => (
            <div key={doc.id} className="p-4 hover:bg-muted flex items-center justify-between">
              ...
              <div className="flex gap-2 ml-4 flex-shrink-0">
                <button className="text-muted-foreground hover:text-blue-600 p-2 rounded hover:bg-blue-50">
                  <Eye className="w-4 h-4" />
                </button>
                <button className="text-muted-foreground hover:text-green-600 p-2 rounded hover:bg-green-50">
      ...
      <div className="border rounded-lg overflow-hidden bg-card">
        <div className="bg-muted border-b p-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold text-foreground">Q&A Section</h3>
          </div>
          <button
        ...
        <div className="divide-y">
          {qaItems.map((item) => (
            <div key={item.id} className="p-4 hover:bg-muted">
              <div className="mb-2">
