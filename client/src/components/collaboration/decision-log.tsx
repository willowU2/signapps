...
const SAMPLE: Decision[] = [
  {
    ...
    status: "active",
    context:
      "Need high performance, memory safety, and concurrency for microservices.",
    decision: "Adopt Axum + Tokio for all backend services.",
    consequences:
      "Steep learning curve, excellent runtime performance, memory safety guarantees.",
    author: "Etienne",
  },
];
              ...
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full ${CATEGORY_COLORS[d.category]}`}
                    >
                      {d.category}
                    </span>
                    <Badge
              ...
              <div className="space-y-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setForm((p) => ({
                      ...p,
                      category: v as Decision["category"],
                    }))
                  }
                >
                  <SelectTrigger>
