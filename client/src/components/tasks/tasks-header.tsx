      ...
      <div className="flex items-start justify-between">
        <div className="flex flex-col space-y-1">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-2 group ml-[2px] mt-1 text-muted-foreground hover:text-foreground transition-colors outline-none cursor-pointer">
                ...
                <svg
                  ...
                  height="16"
                  viewBox="0 0 24 24"
                  className="fill-current opacity-70 group-hover:opacity-100 transition-opacity shrink-0"
                >
            ...
            <DropdownMenuContent
              align="start"
              className="w-56 rounded-xl shadow-lg border-muted z-50"
            >
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            onClick={onAddTask}
            className="shadow-sm hover:shadow-md rounded-full px-4 h-9 font-medium bg-blue-600 hover:bg-blue-700 text-white transition-all cursor-pointer hidden sm:flex"
          >
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent
              align="end"
              className="w-48 rounded-xl shadow-lg z-50"
            >
              <DropdownMenuItem
          ...
          <Button
            data-testid="tasks-add-button-mobile"
            onClick={onAddTask}
            size="icon"
      ...
      <div className="flex items-center justify-between w-full pt-1">
        ...
        >
          <TabsList className="h-9 p-1 bg-muted/40 rounded-lg">
            <TabsTrigger
              data-testid="tasks-view-selector-list"
              value="list"
            ...
            <TabsTrigger
              data-testid="tasks-view-selector-board"
              value="board"
              className="rounded-md px-3 text-xs font-medium transition-all data-[state=active]:bg-background data-[state=active]:shadow-sm"
            >
            ...
            <TabsTrigger
              data-testid="tasks-view-selector-custom-board"
              value="custom-board"
              className="rounded-md px-3 text-xs font-medium transition-all data-[state=active]:bg-background data-[state=active]:shadow-sm"
            >
        ...
        <div className="hidden sm:flex items-center gap-1 text-xs text-muted-foreground">
          <Badge
            variant="outline"
            className="font-normal rounded-full border-muted-foreground/20 text-muted-foreground"
          >
