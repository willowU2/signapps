  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-3">
        {PERIODS.map(p => (
          <button key={p.period} onClick={() => setSelectedPeriod(p.period)} className={`flex-1 rounded-lg border p-3 text-left transition-all ${selectedPeriod === p.period ? "ring-2 ring-blue-500 bg-blue-50 dark:bg-blue-950" : "bg-background hover:border-blue-200"}`}>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="rounded-lg border bg-background overflow-hidden">
          <div className="bg-green-50 dark:bg-green-950/30 border-b px-4 py-3">
            <h3 className="font-semibold text-green-900 dark:text-green-300">TVA collectée (Ventes)</h3>
          </div>
          <table className="w-full text-sm">
            <thead className="bg-muted border-b sticky top-0 z-10">
              <tr><th className="px-4 py-2 text-left text-muted-foreground">Ligne</th><th className="px-4 py-2 text-right text-muted-foreground">Base HT</th><th className="px-4 py-2 text-right text-muted-foreground">Taux</th><th className="px-4 py-2 text-right text-muted-foreground">TVA</th></tr>
            </thead>
        ...
        <div className="rounded-lg border bg-background overflow-hidden">
          <div className="bg-orange-50 dark:bg-orange-950/30 border-b px-4 py-3">
            <h3 className="font-semibold text-orange-900 dark:text-orange-300">TVA déductible (Achats)</h3>
          </div>
          <table className="w-full text-sm">
            <thead className="bg-muted border-b sticky top-0 z-10">
              <tr><th className="px-4 py-2 text-left text-muted-foreground">Ligne</th><th className="px-4 py-2 text-right text-muted-foreground">Base HT</th><th className="px-4 py-2 text-right text-muted-foreground">Taux</th><th className="px-4 py-2 text-right text-muted-foreground">TVA</th></tr>
