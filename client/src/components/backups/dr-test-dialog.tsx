      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Simulates a full recovery for <strong>{profileName}</strong> without
              ...
              {steps.map((step) => (
                ...
                >
                  ...
                  <div>
                    ...
                    {step.detail && (
                      <p
                        className={`text-xs mt-0.5 ${step.status === "failed" ? "text-red-500" : "text-muted-foreground"}`}
                      >
                        {step.detail}
                      </p>
                    )}
