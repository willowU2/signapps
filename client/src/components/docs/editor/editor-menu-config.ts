...
export const editorMenuConfig: DynamicMenuCategory[] = [
        ...
        items: [
          {
            type: "item",
            id: "email-file",
            label: "Envoyer ce fichier par e-mail",
          },
          {
            type: "item",
            id: "email-copy",
            label: "M'envoyer une copie par e-mail",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Supprimer",
        icon: Trash2,
        action: (e) => e?.chain().focus().deleteSelection().run(),
        isDisabled: (e) => !!e?.state.selection.empty,
      },
      ...
      },
      {
        ...
        items: [
          ...
          { type: "item", id: "blk-review", label: "Outil de suivi des avis" },
          {
            type: "item",
            id: "blk-project",
            label: "Suivi des éléments de projet",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          { type: "item", id: "brk-page", label: "Saut de page" },
          {
            type: "item",
            id: "brk-sec-next",
            label: "Saut de section (page suivante)",
          },
          {
            type: "item",
            id: "brk-sec-cont",
            label: "Saut de section (en continu)",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        type: "item",
        id: "fmt-page",
        label: "Passer au format Sans pages",
        icon: Layout,
        iconOpacity: "50",
      },
      ...
      },
      {
        ...
        icon: ImageIcon,
        iconOpacity: "50",
        items: [{ type: "item", id: "img-opt", label: "Options d'image" }],
      },
      {
        type: "submenu",
        id: "fmt-borders",
  ...
  },
  {
    ...
    items: [
        ...
        items: [
          {
            type: "item",
            id: "spell-check",
            label: "Vérification orthographique et grammaticale",
            shortcut: "Ctrl+Alt+X",
          },
      ...
      },
      {
        type: "item",
        id: "tool-review",
        label: "Examiner les modifications suggérées",
        icon: MessageSquareDiff,
        iconOpacity: "50",
        shortcut: "Ctrl+Alt+O Ctrl+Alt+U",
      },
      {
        type: "item",
        id: "tool-compare",
  ...
  },
  {
    ...
    items: [{ type: "item", id: "ext-manage", label: "Gérer les extensions" }],
  },
  {
    id: "help",
    label: "Aide",
