...
export const ColumnBlock = Node.create({
    ...
    renderHTML({ HTMLAttributes }) {
        return ['div', mergeAttributes(HTMLAttributes, { 'data-column-block': '', class: 'column-block min-h-[60px] p-2' }), 0];
    },
});
...
export const Columns = Node.create({
    ...
    addCommands() {
        return {
            ...
            unsetColumns: () => ({ commands }) => commands.lift('columnBlock'),
        };
    },
});
