  ...
  return (
    <div className="p-4 flex flex-col gap-4 h-full animate-fade-in-up">
        ...
        <div className="relative w-10 h-10 flex items-center justify-center">
          ...
          >
            ...
            <circle
              ...
              strokeDasharray={100}
              strokeDashoffset={
                100 - (completedCount / Math.max(1, tasks.length)) * 100
              }
      ...
      <form onSubmit={addTask} className="relative">
        ...
        <button
          type="submit"
          className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 rounded-lg transition-colors"
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar space-y-2 pb-10 mt-2">
        {tasks.map((task) => (
          ...
          >
            <div
              className={`mt-0.5 shrink-0 w-5 h-5 rounded-md border flex items-center justify-center transition-colors ${
                task.completed
                  ...
                  : "border-border dark:border-gray-600 group-hover:border-indigo-400"
              }`}
            >
            ...
            <button
              className="opacity-0 group-hover:opacity-100 p-1 text-gray-400 hover:text-muted-foreground transition-opacity"
