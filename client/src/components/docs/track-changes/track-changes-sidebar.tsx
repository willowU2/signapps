...
export function TrackChangesSidebar({
    ...
    // Stats
    const insertionCount = filteredChanges.filter((c) => c.type === 'insertion').length;
    const deletionCount = filteredChanges.filter((c) => c.type === 'deletion').length;
            ...
            <div className="flex items-center justify-between p-4 border-b">
                <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                        {filteredChanges.length} modification{filteredChanges.length > 1 ? 's' : ''} en attente
                    </p>
                </div>
                {onClose && (
            ...
            <div className="p-3 border-b space-y-2">
                ...
                <div className="flex items-center gap-2">
                    <Badge
                        ...
                        onClick={() => setFilterType(filterType === 'insertion' ? 'all' : 'insertion')}
                    >
                    ...
                    <Badge
                        ...
                        onClick={() => setFilterType(filterType === 'deletion' ? 'all' : 'deletion')}
                    >
