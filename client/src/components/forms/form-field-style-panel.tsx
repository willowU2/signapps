        ...
        <div className="p-3 pt-0 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
              ...
              <div className="flex gap-1">
                {[
                  ...
                  <button
                    key={v}
                    type="button"
                    onClick={() => onChange(setStyle(field, { textAlign: v as "left" | "center" | "right" }))}
                    className={cn(
            ...
            <div className="space-y-1">
              ...
              <Select
                value={s.width || "full"}
                onValueChange={(v) =>
                  onChange(setStyle(field, { width: v as "full" | "half" | "third" | "quarter" }))
                }
              >
                ...
                <SelectContent>
                  <SelectItem value="full" className="text-xs">100%</SelectItem>
                  <SelectItem value="half" className="text-xs">50%</SelectItem>
                  <SelectItem value="third" className="text-xs">33%</SelectItem>
                  <SelectItem value="quarter" className="text-xs">25%</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <Slider
              ...
              max={32}
              step={1}
              onValueChange={([v]) => onChange(setStyle(field, { fontSize: v }))}
            />
          </div>
          <div className="space-y-1">
            ...
            <div className="flex gap-1">
              {["none", "sm", "md", "lg"].map((v) => (
                <button
                  ...
                  type="button"
                  onClick={() =>
                    onChange(setStyle(field, { shadow: v as "none" | "sm" | "md" | "lg" }))
                  }
                  className={cn(
