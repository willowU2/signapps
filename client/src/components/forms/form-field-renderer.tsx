...
import { Star, ArrowUp, ArrowDown, Upload, GripVertical, RotateCcw } from "lucide-react";
...
export function FormFieldRenderer({
      ...
      <div className={wClass}>
        ...
        >
          ...
          <span className="text-sm text-muted-foreground">
            {value instanceof File ? value.name : "Cliquer pour sélectionner un fichier"}
          </span>
          <input
            type="file"
            className="hidden"
  ...
  if (t === "Ranking") {
    return <RankingRenderer field={field} value={value} onChange={onChange} disabled={disabled} />;
  }
