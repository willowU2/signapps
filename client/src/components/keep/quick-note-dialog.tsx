    ...
    return (
        <>
            ...
            <div
                ...
                style={{ backgroundColor: selectedColor === '#202124' ? 'hsl(var(--card))' : selectedColor }}
            >
                {/* Header */}
                ...
                <div className="flex items-center justify-between px-3 py-2 border-t border-border/30">
                            ...
                            {showColors && (
                                <div className="absolute bottom-full left-0 mb-1 p-2 rounded-lg bg-card border shadow-lg flex flex-wrap gap-1 w-[180px]">
                                    {NOTE_COLORS.map(c => (
                                        <button
                                            key={c.id}
                                            onClick={() => { setSelectedColor(c.value); setShowColors(false); }}
                                            className={cn(
                    ...
                    <div className="flex items-center gap-2">
                        <span className="text-[10px] text-muted-foreground">Ctrl+Enter pour sauvegarder</span>
