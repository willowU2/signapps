...
import { Link2, Copy, RefreshCw, Globe, Lock, QrCode, ExternalLink } from "lucide-react"
...
export function PublicCalendarLink({ calendarId, calendarName }: PublicCalendarLinkProps) {
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                {isPublic ? "Anyone with the link can view this calendar" : "Only shared users can access this calendar"}
                            </p>
                        </div>
                    </div>
                    <Switch
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="space-y-1.5">
                            <Label className="text-xs font-semibold text-muted-foreground uppercase tracking-wide flex items-center gap-1.5">
                                ...
                                iCal Feed URL
                                <Badge variant="outline" className="text-[10px] ml-1">Subscribe in any calendar app</Badge>
                            </Label>
                            <div className="flex gap-2">
                                ...
                                <Button
                                    ...
                                    onClick={() => copyToClipboard(publicLink.icalUrl, "iCal URL")}
                                >
