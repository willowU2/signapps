      ...
      >
        <div className="relative w-6 h-6 flex items-center justify-center -ml-1">
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" className="absolute">
            <path
              d="M12 20V12H4V8H12V0H16V8H24V12H16V20H12Z"
      ...
      <div className="flex-1 overflow-y-auto w-[240px] px-1 mt-4">
        ...
        <div className="flex flex-col gap-1 px-2 mt-1">
          {calendars.map((calendar) => (
            <label
              key={calendar.id}
              className="flex items-center gap-3 py-1 cursor-pointer group rounded hover:bg-muted -mx-1 px-1"
            >
              <div className="relative flex items-center justify-center">
                <input
                  ...
                  style={{ color: calendar.color || "#3b82f6" }}
              ...
              <span className="text-sm text-[#3c4043] truncate leading-tight mt-0.5">
                {calendar.name}
              </span>
            </label>
          ))}
