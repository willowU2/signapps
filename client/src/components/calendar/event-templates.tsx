    ...
    <>
      ...
      <Dialog open={editOpen} onOpenChange={setEditOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>
              {editing?.id ? "Edit Template" : "New Event Template"}
            </DialogTitle>
          </DialogHeader>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1">
                <Label className="text-xs">
                  Event title * (use {"{{variable}}"} for dynamic parts)
                </Label>
                <Input
                  className="h-8 text-sm"
                  value={editing.title || ""}
                  ...
                  <div className="flex flex-wrap gap-1">
                    {DURATION_PRESETS.map((d) => (
                      <button
                        ...
                        onClick={() =>
                          setEditing({ ...editing, durationMinutes: d })
                        }
                      >
                        {d < 60 ? `${d}m` : `${d / 60}h`}
                      </button>
