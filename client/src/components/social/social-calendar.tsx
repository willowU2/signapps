...
export function SocialCalendar() {
  const { posts, accounts, fetchPosts, schedulePost, deletePost, createPost } =
    useSocialStore();
  ...
  const getPostsForDay = useCallback(
    (day: Date) =>
      scheduledEnriched.filter((p) => isSameDay(parseISO(p.scheduledAt!), day)),
    [scheduledEnriched],
  );
  ...
  const listTotalPages = Math.max(
    1,
    Math.ceil(listFilteredPosts.length / LIST_PAGE_SIZE),
  );
                  ...
                  >
                    ...
                    <div className="flex-1 p-2 relative group">
                      {hourPosts.length > 0 ? (
                        ...
                        <button
                          onClick={() =>
                            handleCreatePostAtTime(currentDate, hour)
                          }
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              <Select
                ...
                onValueChange={setListPlatformFilter}
              >
              ...
              <Select
                ...
                onValueChange={setListStatusFilter}
              >
              ...
              <span className="text-xs text-muted-foreground ml-auto">
                {listFilteredPosts.length} post
                {listFilteredPosts.length !== 1 ? "s" : ""}
              </span>
            </div>
            ...
            <div className="border rounded-xl overflow-hidden divide-y">
              ...
              {listPagePosts.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <h3 className="text-lg font-semibold">Aucun post</h3>
                ...
                listPagePosts.map((post) => {
                  ...
                  return (
                    <div
                      ...
                      draggable
                      onDragStart={(e) =>
                        setDragData(e as unknown as DragEvent, post.id)
                      }
            ...
            {listTotalPages > 1 && (
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    setListPage(Math.min(listTotalPages - 1, listPage + 1))
                  }
          ...
          <div className="border rounded-xl p-4 space-y-3">
            ...
            {getPostsForDayRaw(selectedDay).length === 0 ? (
              <p className="text-sm text-muted-foreground">
                Aucun post programme pour cette journee.
              </p>
            ) : (
          ...
          <div className="border rounded-xl p-4 space-y-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {selectedPost.scheduledAt && (
                <span className="text-xs text-muted-foreground">
                  Scheduled:{" "}
                  {format(parseISO(selectedPost.scheduledAt), "PPP p")}
                </span>
              )}
              {selectedPost.repeatInterval &&
                selectedPost.repeatInterval > 0 && (
                  <Badge
                    variant="outline"
                    className="text-xs flex items-center gap-1"
                  >
                    <Repeat className="h-3 w-3" />
                    Every {selectedPost.repeatInterval} day
        ...
        >
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This post has already been published. Rescheduling will change
                its scheduled date to{" "}
                <strong>
                  {rescheduleConfirm
