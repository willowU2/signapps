...
export default function AirQuality() {
  const [readings] = useState<AirQualityReading[]>([
    ...
    { id: "2", room: "Office A", co2: 650, voc: 150, humidity: 52, status: "moderate" },
    { id: "3", room: "Meeting Room", co2: 1200, voc: 320, humidity: 60, status: "poor" },
    { id: "4", room: "Kitchen", co2: 520, voc: 200, humidity: 55, status: "moderate" },
  ]);
  ...
  const getGaugeColor = (value: number, threshold1: number, threshold2: number) => {
              ...
              <div>
                ...
                <div className="mt-2 h-1 bg-gray-200 rounded">
                  <div
                    ...
                    style={{ width: `${Math.min(100, (reading.co2 / 1200) * 100)}%` }}
                  />
                </div>
              </div>
              <div>
                ...
                <div className="mt-2 h-1 bg-gray-200 rounded">
                  <div
                    ...
                    style={{ width: `${Math.min(100, (reading.voc / 500) * 100)}%` }}
                  />
                </div>
              </div>
              <div>
