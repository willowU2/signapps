      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Track and manage property leases
          </p>
        </div>
          ...
          {selectedLease ? (
            <div className="rounded-lg border bg-card p-6 space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div
                  className={`rounded-lg p-3 ${getStatusColor(selectedLease.status).bg}`}
                >
                  <p className="text-xs font-semibold text-muted-foreground uppercase">
                    Status
                  </p>
                  <p
                    className={`text-sm font-bold mt-1 ${getStatusColor(selectedLease.status).text}`}
                  >
                    {selectedLease.status.charAt(0).toUpperCase() +
                      selectedLease.status.slice(1)}
                  </p>
                </div>
              </div>
