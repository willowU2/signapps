...
export function CertificateGenerator() {
  const [cert, setCert] = useState<CertData>({
    ...
    description:
      "Has successfully completed all required modules and demonstrated proficiency in using the SignApps Platform for business operations.",
      ...
      <CardContent className="space-y-4">
          ...
          >
            ...
            {[
              ...
              <div
                ...
                style={{
                  border: `3px solid ${cert.borderColor}`,
                  borderRadius: i < 2 ? "0 0 8px 0" : "8px 0 0 0",
                }}
              />
            ))}
        ...
        <div className="flex gap-2 justify-center">
          {BORDER_COLORS.map((c) => (
            <button
              key={c}
              onClick={() => setCert((p) => ({ ...p, borderColor: c }))}
          ...
          {(
            ...
            <div key={field} className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setCert((p) => ({ ...p, [field]: e.target.value }))
                }
