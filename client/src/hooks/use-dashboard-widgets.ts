...
const DEFAULT_LAYOUT: DashboardLayout = {
  ...
  widgets: [
    { id: 'w_myday', type: 'my-day', title: 'Ma journée', size: '2x2', position: { col: 0, row: 0 }, config: {}, visible: true },
    { id: 'w_activity', type: 'activity-timeline', title: 'Activité', size: '2x1', position: { col: 2, row: 0 }, config: {}, visible: true },
    { id: 'w_notifications', type: 'notification-center', title: 'Notifications', size: '1x1', position: { col: 2, row: 1 }, config: {}, visible: true },
    { id: 'w_deadlines', type: 'upcoming-deadlines', title: 'Échéances', size: '1x1', position: { col: 3, row: 1 }, config: {}, visible: true },
    { id: 'w_kpi', type: 'kpi-cards', title: 'KPIs', size: '3x1', position: { col: 0, row: 2 }, config: {}, visible: true },
    { id: 'w_projects', type: 'project-progress', title: 'Projets', size: '1x1', position: { col: 3, row: 2 }, config: {}, visible: true },
    { id: 'w_team', type: 'team-feed', title: 'Équipe', size: '2x1', position: { col: 0, row: 3 }, config: {}, visible: true },
  ],
};
...
export function useDashboardWidgets() {
  ...
  const moveWidget = useCallback((id: string, position: { col: number; row: number }) => {
    const current = load();
    const next = {
      ...current,
      updatedAt: new Date().toISOString(),
  ...
  return {
    ...
    updateLayout, moveWidget, resizeWidget, toggleWidget, addWidget, removeWidget, resetLayout,
  };
}
