...
interface ResourcesState {
    ...
    createResourceType: (data: CreateResourceTypeRequest) => Promise<ResourceType>;
    ...
    createReservation: (resourceId: string, eventId?: string, notes?: string) => Promise<Reservation>;
...
export const useResourcesStore = create<ResourcesState>()((set, get) => ({
    ...
    updateResource: async (id, data) => {
        ...
        set(state => ({
            ...
            selectedResource: state.selectedResource?.id === id ? response.data : state.selectedResource,
        }));
    },
    ...
    approveReservation: async (id) => {
        ...
        set(state => ({
            reservations: state.reservations.map(r => r.id === id ? response.data : r),
...
export const useResourceTypes = () => useResourcesStore(state => state.resourceTypes);
export const usePendingReservations = () => useResourcesStore(state => state.pendingReservations);
