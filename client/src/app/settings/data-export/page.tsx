...
export default function DataExportPage() {
  ...
  const handleExport = async () => {
    ...
    // TODO: wire to backend GDPR export API when available
    // For now, generate a manifest of selected categories
    const exportData = {
      export_date: new Date().toISOString(),
      format: "GDPR Data Export",
      categories: Array.from(selectedCategories),
      note: "Export reel non disponible — les donnees seront recuperees depuis les services backend correspondants.",
    };
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Telechargez ou supprimez vos donnees personnelles conformement au
              RGPD
            </p>
          </div>
        </div>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Selectionnez les categories de donnees a inclure dans
                  l&apos;export. Le fichier sera genere au format JSON.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
        ...
        <Card className="border-red-500/20">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  ...
                  definitivement supprimees dans un delai de 30 jours
          ...
          <CardContent className="space-y-4">
            <div className="bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 rounded-lg p-3 flex items-start gap-2">
              ...
              <div className="text-sm text-red-800 dark:text-red-200 space-y-1">
                ...
                <ul className="list-disc list-inside text-xs space-y-0.5">
                  <li>
                    Tous vos fichiers, emails et messages seront supprimes
                  </li>
            ...
            <p className="text-sm text-muted-foreground">
              Nous vous recommandons de telecharger vos donnees avant de
        ...
        <Card>
          ...
          <CardContent className="text-sm text-muted-foreground space-y-2">
            ...
            <p className="text-xs">
              ...
              <a
                href="mailto:dpo@signapps.local"
