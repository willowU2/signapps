      ...
      <div className="p-6 max-w-4xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Configurez les connexions entre modules, automatisations et intégrations externes.
          </p>
        </div>
        ...
        <Tabs defaultValue="settings" className="space-y-4">
          <TabsList className="grid grid-cols-5 w-full h-9">
            ...
            <TabsTrigger value="sync" className="text-xs">Sync & Templates</TabsTrigger>
            <TabsTrigger value="api" className="text-xs">API & Santé</TabsTrigger>
            <TabsTrigger value="data" className="text-xs">Données</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="settings" className="space-y-4">
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Activez ou désactivez les connexions automatiques entre modules.</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Recevez un résumé de toutes les activités par email.</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Règles déclencheur → action entre modules.</CardDescription>
              </CardHeader>
              <CardContent>
                <AutomationWorkflows />
              </CardContent>
          ...
          <TabsContent value="analytics">
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-base">Métriques multi-modules</CardTitle>
                <CardDescription>Vue d'ensemble de l'activité à travers tous les modules.</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="sync" className="space-y-4">
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Les changements dans un module se propagent aux modules liés.</CardDescription>
              </CardHeader>
              <CardContent>
                <DataSyncRules />
              </CardContent>
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-base">Templates multi-modules</CardTitle>
                <CardDescription>Créez des éléments dans plusieurs modules simultanément.</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="api" className="space-y-4">
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Accès programmatique à l'API unifiée SignApps.</CardDescription>
              </CardHeader>
              <CardContent>
                <CrossModuleApiKeys />
              </CardContent>
            ...
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>État en temps réel de tous les microservices.</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="data" className="space-y-4">
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Exportez vos données de plusieurs modules en une seule fois.</CardDescription>
              </CardHeader>
              <CardContent>
                <Button onClick={() => setExportOpen(true)} className="gap-2">
                  <Download className="w-4 h-4" />Exporter mes données
                </Button>
                <UnifiedExportDialog open={exportOpen} onClose={() => setExportOpen(false)} />
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-base">Import intelligent</CardTitle>
                <CardDescription>Importez n'importe quel fichier — le module cible est détecté automatiquement.</CardDescription>
              </CardHeader>
              <CardContent>
                <SmartImport />
              </CardContent>
