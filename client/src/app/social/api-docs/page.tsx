...
const ENDPOINTS: Endpoint[] = [
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: "ISO 8601",
        required: false,
        description: "Schedule the post at this time",
      },
      {
        name: "hashtags",
        type: "string[]",
      ...
      },
      {
        ...
        type: "string[]",
        required: false,
        description: "Attached image/video URLs",
      },
    ],
    example: {
  ...
  },
  {
    ...
    example: {
      request: JSON.stringify(
        { content: "Updated content", scheduled_at: "2026-04-02T10:00:00Z" },
        null,
        2,
      ),
      response: JSON.stringify(
        { id: "post_abc", status: "scheduled" },
        null,
        2,
      ),
    },
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: "boolean",
        required: false,
        description: "Only return unread items",
      },
    ],
    example: {
      response: JSON.stringify(
...
export default function ApiDocsPage() {
  usePageTitle("Social — Documentation API");
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <div>
        <h1 className="text-3xl font-bold">SignApps Social API</h1>
        <p className="text-muted-foreground mt-2 text-lg">
          Programmatic access to your social media management. Create posts,
          fetch analytics, manage accounts.
        </p>
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm">
          <p>
            All API requests must include an <strong>Authorization</strong>{" "}
            header:
          </p>
          ...
          <Card key={i}>
            <CardContent className="pt-4 space-y-3">
              <div className="flex items-center gap-3 flex-wrap">
                <span
                  className={`px-2.5 py-0.5 rounded-md text-xs font-bold font-mono ${METHOD_COLORS[ep.method]}`}
                >
                  {ep.method}
                </span>
