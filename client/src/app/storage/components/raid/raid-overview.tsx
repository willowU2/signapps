              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 text-center">
                ...
                <div>
                  <p className="text-2xl font-bold text-green-600">
                    {health.arrays_healthy}
                  </p>
                  <p className="text-sm text-muted-foreground">OK</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-yellow-600">
                    {health.arrays_degraded}
                  </p>
              ...
              {arrays.map((array) => (
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-4">
                      <div
                        className={`flex h-10 w-10 items-center justify-center rounded-lg ${getRaidLevelColor(array.raid_level)} text-white font-bold text-xs`}
                      >
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        {array.status === "degraded" && onRebuildArray && (
                          <DropdownMenuItem
                            onClick={() => onRebuildArray(array.id)}
                          >
                            <RefreshCw className="mr-2 h-4 w-4" />
                            Reconstruire
                          </DropdownMenuItem>
                  ...
                  <div className="mt-4">
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span>
                        {formatBytes(array.used_size_bytes ?? 0)} /{" "}
                        {formatBytes(array.total_size_bytes ?? 0)}
                      </span>
                    </div>
                    <Progress
                      value={
                        array.total_size_bytes > 0
                          ? ((array.used_size_bytes ?? 0) /
                              array.total_size_bytes) *
                            100
                          : 0
                      }
                      className="h-2"
                  ...
                  {array.status === "rebuilding" &&
                    array.rebuild_progress !== undefined && (
                      <div className="mt-3">
                        <div className="flex justify-between text-sm mb-1">
