...
export function ArrayDetailDialog({
  array,
  open,
  onOpenChange,
}: ArrayDetailDialogProps) {
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-medium">
                {formatBytes(array.total_size_bytes)}
              </p>
            </div>
            <div>
          ...
          <div>
            <div className="flex justify-between text-sm mb-2">
              ...
              <span>
                {formatBytes(array.used_size_bytes)} /{" "}
                {formatBytes(array.total_size_bytes)}({usagePercent.toFixed(1)}
                %)
              </span>
            </div>
