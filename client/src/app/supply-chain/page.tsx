...
const subPages = [
  {
    href: "/supply-chain/warehouse-map",
    icon: Map,
    label: "Carte entrepôt",
    color: "text-blue-500",
  },
  {
  ...
  {
    href: "/supply-chain/receiving-shipping",
    icon: Truck,
    label: "Réception / Expédition",
    color: "text-orange-500",
  },
  {
    href: "/supply-chain/stock-alerts",
    icon: AlertTriangle,
    label: "Alertes stock",
    color: "text-red-500",
  },
  ...
  {
    href: "/supply-chain/delivery-tracking",
    icon: BarChart2,
...
export default function SupplyChainPage() {
  usePageTitle("Chaîne d'approvisionnement");
  return (
    <AppLayout>
      <div className="space-y-6 p-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Gérez vos stocks, commandes et livraisons.
          </p>
        </div>
