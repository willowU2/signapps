...
const SHIPMENTS: Shipment[] = [
  {
    ...
    events: [
      ...
      },
      {
        id: "e2",
        status: "Picked Up",
        location: "Lyon DHL Hub",
        timestamp: new Date(Date.now() - 2 * 86400000),
        note: "Package collected by DHL",
      },
      {
        id: "e3",
        status: "In Transit",
        location: "Paris CDG Hub",
        timestamp: new Date(Date.now() - 86400000),
        note: "Arrived at Paris sorting facility",
      },
      {
        id: "e4",
        ...
        timestamp: new Date(Date.now() + 2 * 86400000),
        note: "Scheduled for delivery",
      },
    ],
  },
  {
    id: "2",
    trackingNumber: "SP-2026-00839",
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        id: "e5",
        status: "Delivered",
        location: "Paris Office - Reception",
        timestamp: new Date(Date.now() - 2 * 86400000),
        note: "Signed by: Reception Team",
      },
    ],
  },
];
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Real-time shipment status and timeline
            </p>
          </div>
        </div>
                ...
                >
                  <CardContent className="p-4 space-y-1.5">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className={cn("text-xs", ssc.color)}>
                        {ssc.label}
                      </Badge>
                    </div>
                    ...
                    <div className="text-xs text-muted-foreground flex items-center gap-3">
                      ...
                      <span className="flex items-center gap-0.5">
                        ...
                        {format(s.estimatedDelivery, "MMM d")}
                      </span>
                    </div>
                  </CardContent>
                </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between flex-wrap gap-4 mb-6">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {selected.poNumber} · {selected.supplier} ·{" "}
                      {selected.carrier}
                    </p>
                  </div>
                  <div className="text-right text-sm">
                    <div className="flex items-center gap-1 justify-end">
                      ...
                      <span className="font-bold">
                        {format(selected.estimatedDelivery, "MMM d, yyyy")}
                      </span>
                    </div>
                    <p className="text-muted-foreground">
                      {selected.items} items · {selected.weight}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 text-sm bg-muted/50 rounded-lg p-3 mb-6">
                  ...
                  <div className="flex-1 h-px bg-border relative">
                    <Truck className="h-4 w-4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-primary" />
                  </div>
                  <div className="flex items-center gap-1.5">
