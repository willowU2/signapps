...
const SUPPLIERS: Supplier[] = [
  {
    ...
    rating: 4.8,
    ordersTotal: 24500,
    lastOrder: new Date(Date.now() - 3 * 86400000),
    onTimeRate: 96,
  ...
  },
  {
    ...
    email: "b2b@officeessentials.fr",
    phone: "+33 4 56 78 90 12",
    website: "officeessentials.fr",
    status: "active",
    rating: 4.5,
    ordersTotal: 18200,
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Self-service portal for suppliers — orders, invoices, and
                catalog
              </p>
            </div>
          </div>
                  ...
                  <CardContent className="p-5 space-y-3">
                        ...
                        <div className="flex items-start justify-between gap-1">
                          ...
                          <Badge
                            className={cn(
                              ...
                              supplierStatusConfig[s.status].color,
                            )}
                          >
                            {s.status}
                          </Badge>
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        className="flex-1"
                        onClick={() =>
                          toast.success(`Email envoyé to ${s.name}`)
                        }
                      >
                      ...
                      <Button
                        ...
                        variant="outline"
                        className="flex-1"
                        onClick={() => toast.success("Portal link copied")}
                      >
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between flex-wrap gap-3">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Ordered {format(order.date, "MMM d")} · Expected{" "}
                          {format(order.expectedDelivery, "MMM d")}
                        </p>
                      </div>
