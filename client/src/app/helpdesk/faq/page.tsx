...
const INITIAL_ARTICLES: FaqArticle[] = [
  {
    ...
    answer:
      'Pour creer votre compte, rendez-vous sur la page de connexion et cliquez sur "Creer un compte". Renseignez votre email professionnel et suivez les instructions de configuration. Un email de verification vous sera envoye.',
  ...
  },
  {
    ...
    answer:
      'Depuis les Parametres > Membres, cliquez sur "Inviter". Saisissez les adresses email de vos collaborateurs et definissez leur role (Admin, Editeur, Lecteur). Ils recevront une invitation par email valable 7 jours.',
    category: "getting-started",
    likes: 38,
    dislikes: 1,
    userVote: null,
  },
  {
    ...
    answer:
      "Allez dans Parametres > Securite > Mot de passe. Saisissez votre mot de passe actuel puis le nouveau deux fois pour confirmation. Le mot de passe doit contenir au moins 8 caracteres, une majuscule et un chiffre.",
    category: "account",
    likes: 29,
    dislikes: 0,
    userVote: null,
  },
  {
    ...
    answer:
      'Rendez-vous dans Parametres > Securite > Authentification. Cliquez sur "Activer la 2FA" et scannez le QR code avec une application d\'authentification (Google Authenticator, Authy). Entrez le code a 6 chiffres pour confirmer.',
    category: "security",
    likes: 55,
    dislikes: 3,
    userVote: null,
  },
  {
    ...
    answer:
      "SignApps propose trois plans : Starter (gratuit, 5 utilisateurs), Business (19€/utilisateur/mois) et Enterprise (tarif sur mesure). La facturation est mensuelle ou annuelle avec -20% sur l'annuel. Cartes bancaires, virements SEPA et bons de commande acceptes.",
    category: "billing",
    likes: 67,
    dislikes: 5,
    userVote: null,
  },
  {
    ...
    answer:
      "Dans Parametres > Facturation > Historique, vous retrouvez toutes vos factures. Cliquez sur l'icone de telechargement a cote de la facture souhaitee. Les factures sont au format PDF avec les mentions legales obligatoires.",
    category: "billing",
    likes: 44,
    dislikes: 1,
    userVote: null,
  },
  {
    ...
    answer:
      'Dans l\'application Formulaires, cliquez sur "Nouveau formulaire". Ajoutez vos champs puis depuis la palette de champs, selectionnez "Signature electronique". Vous pouvez definir les signataires et configurer les rappels automatiques.',
    category: "features",
    likes: 89,
    dislikes: 4,
    userVote: null,
  },
  {
    ...
    answer:
      "SignApps s'integre avec : Slack, Teams, Zapier, Make, Google Workspace, Microsoft 365, Salesforce, HubSpot et plus de 200 applications via Zapier. Les integrations se configurent dans Parametres > Integrations.",
  ...
  },
  {
    ...
    answer:
      "Vos donnees sont hebergees en France dans des datacenters certifies ISO 27001 et HDS. SignApps est conforme RGPD. Vous pouvez exporter toutes vos donnees a tout moment depuis Parametres > Confidentialite > Exporter mes donnees.",
    category: "security",
    likes: 102,
    dislikes: 2,
    userVote: null,
...
export default function FaqPage() {
  ...
  const handleVote = (articleId: string, vote: "like" | "dislike") => {
    setArticles((prev) => {
      ...
      updated.forEach((a) => {
        if (a.userVote) votes[a.id] = a.userVote;
      });
      try {
      ...
      <div className="p-6 space-y-6 max-w-4xl mx-auto" id="main-content">
        ...
        {search && (
          <p className="text-sm text-muted-foreground text-center">
            {filtered.length} resultat{filtered.length !== 1 ? "s" : ""} pour "
            {search}"
          </p>
        )}
                ...
                <div className="space-y-2">
                  {cat.articles.map((article) => {
                    ...
                    return (
                      ...
                      >
                        <Card
                          className={`transition-colors ${isOpen ? "border-primary/40" : ""}`}
                        >
