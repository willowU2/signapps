        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1">
              Pipeline, opportunités et suivi commercial.
            </p>
          </div>
          <Button
        ...
        <Tabs defaultValue="kanban">
          <TabsList className="flex-wrap h-auto gap-1">
            ...
            <TabsTrigger
              ...
              className="gap-1.5"
              data-testid="crm-tab-billing-report"
            >
              <DollarSign className="h-3.5 w-3.5" /> Facturation
            </TabsTrigger>
            <TabsTrigger
              value="billing-forecast"
              className="gap-1.5"
              data-testid="crm-tab-billing-forecast"
            >
        ...
        <DialogContent>
          ...
          <div className="grid grid-cols-2 gap-3 py-2">
            <div className="col-span-2 space-y-1">
              ...
              <Input
                ...
                data-testid="crm-deal-title-input"
              />
            </div>
            <div className="space-y-1">
              ...
              <Input
                ...
                data-testid="crm-deal-company-input"
              />
            </div>
            <div className="space-y-1">
              <Label>
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                data-testid="crm-deal-value-input"
              />
            </div>
            <div className="space-y-1">
              <Label>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              data-testid="crm-deal-submit-button"
            >
              Créer
            </Button>
          </DialogFooter>
