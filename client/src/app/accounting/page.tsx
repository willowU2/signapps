...
const TABS = [
  {
    ...
    icon: BookOpen,
    desc: "Arbre CRUD comptes",
  },
  {
    id: "journal",
    label: "Saisie d'écritures",
    icon: PenLine,
    desc: "Débit/crédit équilibré",
  },
  {
    id: "bank-reconciliation",
    label: "Rapprochement bancaire",
    icon: RefreshCw,
    desc: "Import & matching",
  },
  {
    id: "financial-statements",
    label: "Bilan & Résultats",
    icon: FileBarChart,
    desc: "Auto depuis écritures",
  },
  {
    id: "invoices",
    label: "Factures clients",
    icon: FileText,
    desc: "Créer/envoyer/suivre",
  },
  {
    id: "expenses",
    label: "Notes de frais",
    icon: Receipt,
    desc: "Soumettre & approuver",
  },
  {
    id: "budget",
    label: "Budget prévisionnel",
    icon: BarChart2,
    desc: "Budget vs réalisé",
  },
  {
    id: "cashflow",
    label: "Cash Flow",
    icon: TrendingUp,
    desc: "Entrées/sorties timeline",
  },
  {
    id: "vat",
  ...
  {
    id: "import",
    label: "Import CSV / FEC",
    icon: Upload,
    desc: "Parseur & validation",
  },
] as const;
...
export default function AccountingPage() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "invoices":
        return <ClientInvoiceManagement />;
      case "expenses":
