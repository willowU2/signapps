        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Completion rates, scores, and engagement metrics
            </p>
          </div>
        </div>
        ...
        <Tabs defaultValue="overview">
          ...
          <TabsContent value="overview" className="space-y-6 mt-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  <CardTitle className="text-sm">My Learning Summary</CardTitle>
                </CardHeader>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  {[
                    {
                      title: "Fast Learner",
                      desc: "Completed 3 courses in one week",
                      icon: "⚡",
                    },
                    {
                      title: "Perfect Score",
                      desc: "Scored 100% on Security quiz",
                      icon: "🎯",
                    },
                    {
                      title: "First Course",
                    ...
                    {
                      title: "Team Player",
                      desc: "Shared notes with 5 colleagues",
                      icon: "🤝",
                    },
                  ].map((a) => (
