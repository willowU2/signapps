...
const PATHS: LearningPath[] = [
  {
    id: "1",
    title: "SignApps Essentials",
    description:
      "Master the core SignApps platform modules from onboarding to power user.",
    level: "Beginner",
    estimatedTime: 8,
    enrolledCount: 234,
  ...
  },
  {
    ...
    description:
      "Deep dive into security practices, RBAC, audit trails, and compliance.",
    level: "Intermediate",
    estimatedTime: 12,
    enrolledCount: 89,
  ...
  },
  {
    ...
    description:
      "Full platform administration: users, permissions, integrations, and monitoring.",
    level: "Advanced",
    estimatedTime: 20,
    enrolledCount: 42,
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Structured sequences of courses to master specific skills
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          {PATHS.map((path) => {
            ...
            const done = path.courses.filter(
            ...
            return (
              <Card
                key={path.id}
                className={cn("transition-shadow", isOpen && "shadow-md")}
              >
                <CardHeader
                    ...
                    <div className="border-t pt-4 space-y-2">
                      {path.courses.map((course, idx) => {
                        ...
                        return (
                          ...
                          >
                            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-muted shrink-0 text-xs font-bold">
                              {idx + 1}
                            </div>
                            <div className="flex-1 min-w-0">
