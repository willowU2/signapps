...
const COURSES: Course[] = [
  {
    ...
    description:
      "Get started with the SignApps platform. Learn navigation, core features, and best practices.",
  ...
  },
  {
    ...
    description:
      "Master document workflows, templates, and collaboration features in SignApps Docs.",
    ...
    tags: ["documents", "workflows"],
  },
  {
    id: "3",
    title: "Security & Compliance Essentials",
    description:
      "Deep dive into RBAC, audit logs, encryption, and compliance best practices.",
  ...
  {
    id: "4",
    title: "Calendar & Scheduling Mastery",
    description:
      "Leverage the full power of SignApps Calendar for team coordination and resource booking.",
    instructor: "Dave Lee",
    level: "Beginner",
  ...
  },
  {
    ...
    description:
      "Build powerful integrations using the SignApps REST API and webhook system.",
    instructor: "Eve Park",
    level: "Advanced",
  ...
  },
  {
    ...
    description:
      "Use SignApps Workforce for org charts, employee management, and HR workflows.",
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Browse and enroll in learning courses
            </p>
          </div>
        </div>
              ...
              <div className={cn("h-32 relative", course.thumbnail)}>
                ...
                {course.progress !== undefined && (
                  <div className="absolute bottom-0 left-0 right-0 h-1 bg-card/20">
                    <div
                      className="h-full bg-card/80 transition-all"
