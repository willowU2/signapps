...
const CERTS: Certificate[] = [
  {
    id: "1",
    courseName: "Introduction to SignApps Platform",
    studentName: "Etienne Dupont",
  ...
  {
    id: "2",
    courseName: "Advanced Document Management",
    studentName: "Etienne Dupont",
    completedAt: new Date("2026-02-28"),
    score: 87,
    instructor: "Bob Smith",
    hours: 5,
    certNumber: "CERT-2026-002",
  },
  {
    id: "3",
    courseName: "Security & Compliance Essentials",
    studentName: "Etienne Dupont",
    completedAt: new Date("2026-01-20"),
    score: 92,
    instructor: "Carol Johnson",
    hours: 4,
    certNumber: "CERT-2026-003",
  },
];
...
function CertificatePreview({ cert }: { cert: Certificate }) {
  return (
    <div className="bg-card text-foreground rounded-2xl border-4 border-yellow-400 p-8 text-center shadow-xl mx-auto max-w-lg">
      ...
      <p className="text-sm font-semibold uppercase tracking-widest text-yellow-600 mb-2">
      ...
      <div className="border-t border-slate-200 pt-4">
        ...
        <div className="mt-2 text-xs text-slate-400">
          {cert.hours} hours of learning · SignApps Learning Platform
        </div>
      </div>
    </div>
  );
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Auto-generated PDF certificates for completed courses
            </p>
          </div>
        </div>
        ...
        {CERTS.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1 max-w-sm">
              Completez des formations pour obtenir des certificats.
            </p>
          </div>
        )}
