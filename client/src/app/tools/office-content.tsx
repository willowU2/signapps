    ...
    <div className="grid gap-6 md:grid-cols-2">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Upload a DOCX, Markdown, HTML, or TXT file
          </CardDescription>
        </CardHeader>
          ...
          {importResult && (
            <div className="text-xs text-muted-foreground space-y-1 rounded-lg bg-muted/50 p-3">
              ...
              <p>
                ...
                {importResult.metadata.word_count.toLocaleString()}
              </p>
              <p>
                <span className="font-medium">Characters:</span>{" "}
                {importResult.metadata.character_count.toLocaleString()}
              </p>
              {importResult.metadata.has_tables && (
                <Badge variant="outline" className="text-xs">
                  Tables
                </Badge>
              )}
              {importResult.metadata.has_images && (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select the target format and convert
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Select
              value={outputFormat}
              onValueChange={(v) => setOutputFormat(v as ExportFormat)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
        ...
        <div className="flex items-center justify-between pb-4 border-b border-border/50">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Document conversion, spreadsheet import/export, PDF utilities, and
              presentation export
            </p>
          </div>
          <Badge
