...
const TEAMS: TeamChannel[] = [
  {
    id: "1",
    name: "Engineering",
    description: "All things code, architecture, and technical decisions",
    type: "public",
    members: 24,
  ...
  },
  {
    id: "2",
    name: "Product",
    description: "Product roadmap, specs, and feature discussions",
    type: "public",
    members: 12,
  ...
  },
  {
    id: "3",
    name: "Sales",
    description: "Sales pipeline, leads, and customer updates",
    type: "public",
    members: 18,
  ...
  },
  {
    id: "6",
    name: "Finance",
    description: "Budget, accounting, and financial reporting",
    type: "private",
    members: 5,
  ...
  },
  {
    id: "8",
    name: "Design",
    description: "UX/UI design, assets, and design system",
    type: "public",
    members: 7,
  ...
  },
  {
    ...
    description: "Onboarding, support, and customer health",
    type: "public",
    members: 11,
  ...
  },
  {
    id: "12",
    name: "Data",
    description: "Analytics, BI, and data engineering",
    type: "public",
    members: 6,
...
export default function TeamsDirectoryPage() {
  ...
  const { data: teams = TEAMS } = useQuery<TeamChannel[]>({
    ...
    queryFn: () =>
      fetch("/api/comms/teams-directory")
        .then((r) => r.json())
        .catch(() => TEAMS),
  });
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Browse all teams and channels across the organization
            </p>
          </div>
        </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5">
              ...
              {team.type === "private" ? (
                ...
                <Globe className="h-3 w-3 text-muted-foreground ml-auto opacity-50" />
              )}
            </div>
