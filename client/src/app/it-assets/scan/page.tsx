...
export default function QRScanPage() {
  ...
  const [auditLog, setAuditLog] = useState<
    Array<{ id: string; name: string; time: string; found: boolean }>
  >([]);
      ...
      <div className="max-w-lg mx-auto space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Scan or enter asset ID to audit inventory
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              In production, connect a USB barcode scanner or camera QR reader.
              The input auto-submits on Enter.
            </p>
          </CardContent>
        </Card>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`px-2 py-0.5 rounded-full text-xs font-medium ${STATUS_COLOR[result.status ?? ""] ?? "bg-muted text-muted-foreground"}`}
                    >
                ...
                {auditLog.map((entry, i) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={
                          entry.found ? "font-medium" : "text-muted-foreground"
                        }
                      >
                        {entry.name}
                      </span>
