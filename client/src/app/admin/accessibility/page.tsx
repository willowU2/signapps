...
function runAccessibilityChecks(doc: Document): AccessibilityIssue[] {
  ...
  const lowContrastEls = Array.from(
    doc.querySelectorAll("p, span, li, td, th"),
  ).filter((el) => !checkContrastRatio(el));
  ...
  return (
    <AppLayout>
      <div className="p-6 space-y-6 max-w-6xl mx-auto">
        <PageHeader
          title="Audit Accessibilite WCAG"
          description="Analyse les pages cles pour les problemes de conformite WCAG 2.1 AA"
            ...
            <Card className={`border-2 ${scoreVariant(globalScore)}`}>
              <CardContent className="pt-6">
                <div className="text-center">
                  <div
                    className={`text-5xl font-bold ${scoreColor(globalScore)}`}
                  >
                    {globalScore}
                  </div>
        ...
        {reports.length > 0 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Cliquez sur une ligne pour voir le detail des problemes
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                  ...
                  {reports.map((report) => {
                    ...
                    return (
                      <TableRow
                        ...
                        onClick={() =>
                          setSelectedPage(
                            selectedPage?.url === report.url ? null : report,
                          )
                        }
                      >
                        ...
                        <TableCell className="text-center">
                          <span
                            className={`font-bold text-lg ${scoreColor(report.score)}`}
                          >
                            {report.score}
                          </span>
                        </TableCell>
        ...
        {selectedPage && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Score:{" "}
                <span className={`font-bold ${scoreColor(selectedPage.score)}`}>
                  {selectedPage.score}/100
                </span>
                {" — "}
          ...
          <Card>
            <CardContent className="py-16 text-center">
              ...
              <p className="text-muted-foreground">
                Cliquez sur "Lancer l'audit" pour analyser les pages de la
                plateforme.
              </p>
            </CardContent>
          </Card>
