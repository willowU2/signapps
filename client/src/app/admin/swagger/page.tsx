...
export default function SwaggerPage() {
  ...
  const [selectedService, setSelectedService] = useState<ServiceSpec>(SERVICES[0]);
      ...
      <div className="space-y-4 p-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold tracking-tight">Swagger UI</h1>
              <p className="text-sm text-muted-foreground mt-0.5">
                Interactive API documentation for all SignApps services.
              </p>
            </div>
          </div>
