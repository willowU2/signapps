...
export default function FloorPlanEditor() {
  ...
  const submitRectangleBinding = () => {
    ...
    const resourceMeta = globalResources.find(
      (r) => r.id === selectedGlobalResource,
    );
      ...
      <div className="flex flex-col min-h-0 flex-1 bg-background">
        ...
        <div className="flex flex-1 overflow-hidden">
              ...
              {!planData.svgContent ? (
                <div className="border-2 border-dashed rounded-xl p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Uploadez un fichier .svg pour servir de base à votre carte.
                  </p>
                  <Input
                    type="file"
                    accept=".svg"
            ...
            <div className="space-y-4 flex-1">
              ...
              {!planData.resources || planData.resources.length === 0 ? (
                <p className="text-sm text-muted-foreground text-center py-4 italic">
                  Aucune hitbox temporelle configurée.
                </p>
              ) : (
                <div className="space-y-2">
                    ...
                    >
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground opacity-70">
                          Bound: {Math.round(res.bounds.width)}x
                          {Math.round(res.bounds.height)}
                        </div>
                      </div>
                      <Button
                        variant="ghost"
                        ...
                        onClick={(e) => {
                          ...
                          setPlanData((prev: Partial<FloorPlanData>) => ({
                            ...
                            resources: prev.resources?.filter(
                              (r: FloorPlanResource) => r.id !== res.id,
                            ),
                          }));
                        }}
          ...
          <div className="flex-1 bg-black/[0.03] overflow-hidden relative touch-none select-none flex items-center justify-center p-8 cursor-crosshair">
            {planData.svgContent ? (
              <div
                className="relative shadow-2xl bg-card border border-border/50 rounded-lg overflow-hidden"
                style={{ width: planData.width, height: planData.height }}
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={`data:image/svg+xml;utf8,${encodeURIComponent(planData.svgContent)}`}
              ...
              <div className="text-muted-foreground flex items-center gap-2">
                <ArrowLeft className="w-4 h-4" /> Veuillez d'abord uploader un
                fond de plan.
              </div>
            )}
          </div>
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Vous venez de dessiner une zone interactive. À quelle ressource
              SignApps cette zone correspond-elle ?
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="py-4 space-y-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={setSelectedGlobalResource}
              >
                <SelectTrigger>
          ...
          <DialogFooter>
            ...
            <Button
              onClick={submitRectangleBinding}
              disabled={!selectedGlobalResource}
            >
              Lier la Ressource
            </Button>
          </DialogFooter>
