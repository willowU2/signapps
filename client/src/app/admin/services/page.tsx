...
const SERVICES: ServiceNode[] = [
  ...
  },
  {
    ...
    deps: ["identity", "storage", "contacts"],
    ...
    <AppLayout>
      <div className="w-full space-y-6">
        <PageHeader
          ...
          description="Graphe de dépendances des microservices SignApps"
        ...
        <div className="flex gap-3 flex-wrap">
          {categories.map((cat) => (
            <Badge key={cat} className={CATEGORY_LABELS[cat].color}>
            ...
            <div key={cat}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                {services.map((svc) => (
                  <Card
                    key={svc.id}
                    className={`${CATEGORY_COLORS[cat]} transition-shadow hover:shadow-md`}
                  >
              ...
              <thead>
                <tr>
                  ...
                  {SERVICES.map((s) => (
                    <th
                      key={s.id}
                      className="px-2 py-1 text-center font-medium writing-mode-vertical"
                      style={{
