          ...
          <TabsContent value="general">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Informations de base de la plateforme et préférences
                  régionales.
                </CardDescription>
              </CardHeader>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Restreindre l&apos;accès à la plateforme aux
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex justify-between">
                  <Button
                    variant="outline"
                    onClick={() =>
                      toast.info("Test d'envoi simulé avec succès")
                    }
                    className="gap-2"
                  >
                    <Mail className="size-4" />
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <CardDescription>
                        Envoyez des notifications vers des services externes
                        lors d&apos;événements.
                      </CardDescription>
                    </div>
                    <Button
