    ...
    <AppLayout>
      <div className="space-y-6">
        <PageHeader
          ...
          description="Manage translations, glossaries and locale settings"
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Language coverage overview — RTL languages (Arabic, Hebrew) are
              fully supported
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-wrap gap-3">
              {SUPPORTED_LOCALES.map((l) => (
                ...
                >
                  ...
                  <Badge
                    variant={STATUS_VARIANTS[l.status]}
