    ...
    <AppLayout>
      <div className="flex flex-col gap-6 pb-24 w-full">
        <PageHeader
          ...
          description="Manage how files are physically routed in storage backends and specify exactly which folders should be synchronized with the AI Vector database."
                ...
                <div className="bg-amber-500/10 border-amber-500/20 text-amber-600 dark:text-amber-400 border p-4 rounded-lg flex gap-3 text-sm items-start mb-6">
                  ...
                  <div>
                    <p className="font-semibold mb-1">
                      Administrative Rules applied on upload
                    </p>
                    <p>
                      Storage rules dictate where new files are placed (on
                      specific disk backends or S3 buckets) depending on their
                      file type and MIME representation. Modifications here{" "}
                      <b>do not retroactively move existing files</b>.
                    </p>
                  </div>
                </div>
              ...
              <TabsContent value="ai-indexing" className="space-y-4 m-0">
                <div className="bg-blue-500/10 border-blue-500/20 text-blue-600 dark:text-blue-400 border p-4 rounded-lg flex gap-3 text-sm items-start mb-6">
                  ...
                  <div>
                    ...
                    <p>
                      By default, new files are not fed to the LLM. Define
                      folder paths and criteria below to ensure specific
                      documents are chunked and available for RAG (Retrieval
