    ...
    >
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Connectez-vous à votre compte SignApps
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form
            ...
            {failedAttempts > 0 &&
              ...
              !isLockedOut && (
                <div className="rounded-lg bg-amber-500/10 border border-amber-500/30 p-3 text-sm text-amber-700 dark:text-amber-400">
                  Tentative {failedAttempts}/{MAX_ATTEMPTS} —{" "}
                  {MAX_ATTEMPTS - failedAttempts} essai
                  {MAX_ATTEMPTS - failedAttempts > 1 ? "s" : ""} restant
                  {MAX_ATTEMPTS - failedAttempts > 1 ? "s" : ""} avant
