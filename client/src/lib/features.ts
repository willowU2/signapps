...
export const FEATURES = {
  ...
  // Chat features
  CHAT_PRESENCE: true, // Indicateurs de présence en ligne (IDEA-136)
  CHAT_UNREAD_COUNT: true, // Compteur de messages non lus (IDEA-140)
  CHAT_REACTIONS: true, // Emoji reactions (IDEA-131)
  CHAT_PINS: true, // Messages épinglés (IDEA-132)
  CHAT_THREADS: true, // Discussions en fil (IDEA-133)
  CHAT_FILES: true, // Partage de fichiers (IDEA-134)
  CHAT_VOICE: true, // Messages vocaux (IDEA-135)
  CHAT_DMS: true, // Messages privés (IDEA-137)
  CHAT_SEARCH: true, // Recherche plein texte (IDEA-138)
  CHAT_NOTIFICATIONS: true, // Notifications bureau (IDEA-139)
  CHAT_PRIVATE_CHANNELS: true, // Canaux privés/publics (IDEA-141)
  CHAT_EXPORT: true, // Export historique (IDEA-142)
  CHAT_MARKDOWN: true, // Rendu Markdown (IDEA-143)
