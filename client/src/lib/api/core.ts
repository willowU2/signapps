...
export const IDENTITY_URL =
  process.env.NEXT_PUBLIC_IDENTITY_URL || "http://localhost:3001/api/v1";
export const CONTAINERS_URL =
  process.env.NEXT_PUBLIC_CONTAINERS_URL || "http://localhost:3002/api/v1";
export const PROXY_URL =
  process.env.NEXT_PUBLIC_PROXY_URL || "http://localhost:3003/api/v1";
export const STORAGE_URL =
  process.env.NEXT_PUBLIC_STORAGE_URL || "http://localhost:3004/api/v1";
export const AI_URL =
  process.env.NEXT_PUBLIC_AI_URL || "http://localhost:3005/api/v1";
export const SECURELINK_URL =
  process.env.NEXT_PUBLIC_SECURELINK_URL || "http://localhost:3006/api/v1";
export const SCHEDULER_URL =
  process.env.NEXT_PUBLIC_SCHEDULER_URL || "http://localhost:3007/api/v1";
export const METRICS_URL =
  process.env.NEXT_PUBLIC_METRICS_URL || "http://localhost:3008/api/v1";
export const MEDIA_URL =
  process.env.NEXT_PUBLIC_MEDIA_URL || "http://localhost:3009/api/v1";
export const DOCS_URL =
  process.env.NEXT_PUBLIC_DOCS_URL || "http://localhost:3010/api/v1";
export const CALENDAR_URL =
  process.env.NEXT_PUBLIC_CALENDAR_URL || "http://localhost:3011/api/v1";
export const MAIL_URL =
  process.env.NEXT_PUBLIC_MAIL_URL || "http://localhost:3012/api/v1";
export const MEET_URL =
  process.env.NEXT_PUBLIC_MEET_URL || "http://localhost:3014/api/v1";
export const IT_ASSETS_URL =
  process.env.NEXT_PUBLIC_IT_ASSETS_URL || "http://localhost:3015/api/v1";
export const PXE_URL =
  process.env.NEXT_PUBLIC_PXE_URL || "http://localhost:3016/api/v1";
export const REMOTE_URL =
  process.env.NEXT_PUBLIC_REMOTE_URL || "http://localhost:3017/api/v1";
