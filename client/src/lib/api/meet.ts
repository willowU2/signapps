...
export const meetApi = {
  ...
  getConfig: () => meetClient.get<MeetConfig>("/meet/config"),

  // ========================================================================
  // Rooms
  // ========================================================================

  listRooms: () => meetClient.get<Room[]>("/meet/rooms"),

  getRoom: (id: string) => meetClient.get<Room>(`/meet/rooms/${id}`),
  ...
  deleteRoom: (id: string) => meetClient.delete(`/meet/rooms/${id}`),

  endRoom: (id: string) => meetClient.post(`/meet/rooms/${id}/end`),

  // ========================================================================
  // Tokens
  // ========================================================================

  getToken: () => meetClient.get<TokenResponse>("/meet/token"),
  ...
  listHistory: () => meetClient.get<MeetingHistory[]>("/meet/history"),
  ...
  voicemails: {
    list: () => meetClient.get<Voicemail[]>("/meet/voicemails"),
    delete: (id: string) => meetClient.delete(`/meet/voicemails/${id}`),
    markRead: (id: string) => meetClient.patch(`/meet/voicemails/${id}/read`),
  },
  ...
  videoMessages: {
    list: () => meetClient.get<VideoMessage[]>("/meet/video-messages"),
    create: (data: CreateVideoMessageRequest) =>
      meetClient.post<VideoMessage>("/meet/video-messages", data),
    delete: (id: string) => meetClient.delete(`/meet/video-messages/${id}`),
    markRead: (id: string) =>
