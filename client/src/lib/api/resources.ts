...
export const resourceTypesApi = {
  ...
  list: () => identityClient.get<ResourceType[]>("/resource-types"),
  ...
  delete: (id: string) => identityClient.delete(`/resource-types/${id}`),
};
...
export const resourcesApi = {
  ...
  /** Get resource by ID */
  get: (id: string) => identityClient.get<Resource>(`/resources/${id}`),
  ...
  /** Delete a resource */
  delete: (id: string) => identityClient.delete(`/resources/${id}`),
};
...
export const reservationsApi = {
  ...
  listPending: () => identityClient.get<Reservation[]>("/reservations/pending"),

  /** Get reservation by ID */
  get: (id: string) => identityClient.get<Reservation>(`/reservations/${id}`),
