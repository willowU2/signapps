...
export const mailApi = {
  ...
  listAccounts: () => mailClient.get<MailAccount[]>("/mail/accounts"),
  ...
  deleteAccount: (id: string) => mailClient.delete(`/mail/accounts/${id}`),
  ...
  getFolder: (id: string) => mailClient.get<MailFolder>(`/mail/folders/${id}`),
  ...
  getEmail: (id: string) => mailClient.get<Email>(`/mail/emails/${id}`),
  ...
  deleteEmail: (id: string) => mailClient.delete(`/mail/emails/${id}`),
  ...
  deleteLabel: (id: string) => mailClient.delete(`/mail/labels/${id}`),
  ...
  getStats: () => mailClient.get<MailStats>("/mail/stats"),
  ...
  deleteTemplate: (id: string) => mailClient.delete(`/mail/templates/${id}`),
};
...
export const mailSpamApi = {
  ...
  train: (data: SpamTrainRequest) => mailClient.post("/mail/spam/train", data),
