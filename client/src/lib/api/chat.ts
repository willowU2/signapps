...
export const chatApi = {
  ...
  getChannels: () => chatClient.get<Channel[]>("/channels"),

  getChannel: (id: string) => chatClient.get<Channel>(`/channels/${id}`),
  ...
  deleteChannel: (id: string) => chatClient.delete(`/channels/${id}`),
  ...
  uploadFile: (
    ...
    return chatClient.post<ChatAttachment>(
  ...
  getDirectMessages: () => chatClient.get<DirectMessage[]>("/dms"),

  createDirectMessage: (data: CreateDmRequest) =>
    chatClient.post<DirectMessage>("/dms", data),

  deleteDirectMessage: (id: string) => chatClient.delete(`/dms/${id}`),
  ...
  getPresence: () => chatClient.get<PresenceEntry[]>("/presence"),
  ...
  searchMessages: (channelId: string, query: string) =>
    chatClient.get<ChatMessage[]>(`/channels/${channelId}/search`, {
      params: { q: query },
    }),
  ...
  markChannelRead: (channelId: string) =>
    chatClient.post<ChannelReadStatus>(
      `/channels/${channelId}/read-status`,
      {},
    ),
