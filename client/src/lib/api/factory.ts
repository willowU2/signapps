...
const SERVICE_CONFIG: Record<ServiceName, ServiceConfig> = {
  ...
  [ServiceName.WORKFORCE]: { port: 3024, envVar: 'NEXT_PUBLIC_WORKFORCE_URL', healthPath: '/health' },
  [ServiceName.CONTACTS]: { port: 3021, envVar: 'NEXT_PUBLIC_CONTACTS_URL', healthPath: '/health' },
  [ServiceName.FORMS]: { port: 3022, envVar: 'NEXT_PUBLIC_FORMS_URL', healthPath: '/health' },
