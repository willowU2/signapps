...
export const connectionApi = {
  ...
  get: async (id: string) =>
    (await remoteClient.get(`/remote/connections/${id}`)).data,
  create: async (data: any) =>
    (await remoteClient.post("/remote/connections", data)).data,
  update: async (id: string, data: any) =>
    (await remoteClient.put(`/remote/connections/${id}`, data)).data,
  delete: async (id: string) => {
    await remoteClient.delete(`/remote/connections/${id}`);
  },
