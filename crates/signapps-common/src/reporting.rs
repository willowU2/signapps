...
//!
//! ```rust,ignore
//! use signapps_common::reporting::{ReportConfig, ReportTemplate, ReportEngine};
//!
...
impl ReportEngine {
    ...
    pub async fn generate(&self, template: &ReportTemplate) -> Result<ReportData> {
    ...
    pub async fn schedule(&self, config: ReportConfig) -> Result<()> {
    ...
    async fn generate_weekly_activity(&self) -> Result<(String, HashMap<String, String>)> {
    ...
    async fn generate_monthly_metrics(&self) -> Result<(String, HashMap<String, String>)> {
        let mut metrics = HashMap::new();
    ...
    async fn generate_security_audit(&self) -> Result<(String, HashMap<String, String>)> {
        let mut metrics = HashMap::new();
    ...
    async fn generate_storage_usage(&self) -> Result<(String, HashMap<String, String>)> {
        let mut metrics = HashMap::new();
