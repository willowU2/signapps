...
/// E2E crypto specific error type.
#[derive(Debug, thiserror::Error)]
pub enum E2eCryptoError {
    /// Invalid base64 encoding in encrypted payload.
    #[error("invalid base64 encoding")]
    InvalidBase64,
    /// Decrypted bytes are not valid UTF-8.
    #[error("invalid UTF-8 in decrypted message")]
    InvalidUtf8,
}
...
impl E2eChannelManager {
    ...
    pub fn create_channel(
        ...
        members: Vec<Uuid>,
        encryption_key: &str,
    ) -> Result<E2eChannel, E2eCryptoError> {
    ...
    pub fn decrypt_message(&self, encrypted: &str, key: &str) -> Result<String, E2eCryptoError> {
        ...
        String::from_utf8(decrypted_bytes).map_err(|_| E2eCryptoError::InvalidUtf8)
    }
